---
id: playwright-jest-on-hyperexecute
title: Run playwright automation tests on HyperExecute using Jest
hide_title: true
sidebar_label: Jest
description: Learn how to run playwright automation tests on HyperExecute using Jest framework
keywords:
  - unittest
  - unittest selenium
  - python selenium
      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "@type": "ListItem",
          "position": 3,
          "name": "How to run playwright automation tests on HyperExecute using Jest framework",
          "item": `${BRAND_URL}/support/docs/playwright-jest-on-hyperexecute/`
        }]
      })
    }}
></script>
...
<a href="https://github.com/LambdaTest/HyperExecute-Playwright-Jest.git" className="github__anchor"><img loading="lazy" src={require('../assets/images/icons/github.png').default} alt="Image" className="doc_img"/> View on GitHub</a>
...
[<img alt="Run in Gitpod" width="200 px" align="center" src="https://user-images.githubusercontent.com/1688653/165307331-fbcf16b0-ce49-40f5-9f87-4f080d674624.png" />](https://hyperexecute.lambdatest.com/hyperexecute/jobs?type=gitpod&frameworkType=PlayWright&framework=Playwright-Jest)
