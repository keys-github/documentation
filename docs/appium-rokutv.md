...
site_name: TestMu AI
slug: appium-rokutv/
canonical: https://www.testmuai.com/support/docs/appium-rokutv/
---
...
- You have access to <BrandName /> username and accessKey. If you have not registered yet, you can do the same by visiting our <a href="https://testmuai.com/register/" onClick={CookieTrackingSignup}>website</a>. You will be able to access the credentials in the [<BrandName /> Profile](https://accounts.lambdatest.com/detail/profile)
...
- You can generate capabilities for your test requirements with the help of our inbuilt **<a href={`${BRAND_URL}/capabilities-generator/`}>Capabilities Generator</a>**.For more details, please refer to our guide on [Desired Capabilities in Appium](/support/docs/desired-capabilities-in-appium/).
...
| *app             | TYPE: STRING <br/> `app=lt://APP100201061631704657918380`              | Accepts App URL returned after uploading an app on the <BrandName /> servers.            |
