...
canonical: https://www.testmuai.com/support/docs/tricentis-tosca-integration-testmu-selenium-grid/
---
...
***
1. Log in to <BrandName />. If you haven’t signed up yet, <a href="https://testmuai.com/register/" onClick={CookieTrackingSignup}>click here</a>.
