...
- **<BrandName /> Account**: An active <BrandName /> account with appropriate licensing. <a href="https://testmuai.com/register/" onClick={CookieTrackingSignup}>Sign up now</a> if you don't have an account yet.
