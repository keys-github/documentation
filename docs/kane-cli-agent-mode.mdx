...
keywords: ['kane cli agent mode', 'ndjson', 'kaneai', 'testmu ai', 'ai agent integration', 'claude code', 'codex cli']
"og:description": "Use the --agent flag to get structured NDJSON output from Kane CLI: designed for AI coding agents like Claude Code, Codex CLI, and Gemini CLI."
---
...
- [Error Codes](/docs/kane-cli-error-codes/): Complete reference of `result_code` values and recommended actions
- [Parallel Execution](/docs/kane-cli-parallel-execution/): Run multiple tests concurrently
