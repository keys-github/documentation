...
"og:description": "Learn how to integrate your jira tickets with KaneAI and test planner using Atalssian Marketplace"
---
...
- **Access the Test Case :** Click on the link provided by Kane AI in the Jira comment. This will create a [Test Plan](/docs/kane-ai-test-plan/#step-2-define-your-state-outcomes-error-messages-constraints-and-user-inputs) for you to review and execute via KaneAI.
