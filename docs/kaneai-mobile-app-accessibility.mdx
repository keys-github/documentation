...
keywords: ['testmu ai automation', 'testmu ai kaneai', 'kaneai mobile app', 'accessibility testing', 'mobile accessibility', 'accessibility scan']
"og:description": "Learn how to perform automated accessibility testing for native mobile applications using KaneAI's accessibility scan feature."
---
...
<img loading="lazy" src='/assets/images/kane-ai/features/mobile-accessibility/add-accessibility-instruction.png' alt="add-accessibility-instruction" />
...
<img loading="lazy" src='/assets/images/kane-ai/features/mobile-accessibility/accessibility-instruction-authored.png' alt="accessibility-instruction-authored" />
...
<img loading="lazy" src='/assets/images/kane-ai/features/mobile-accessibility/test-case-summary.png' alt="test-case-summary" />

To view the screenshot of the screen where the accessibility scan was performed, click the (•••) icon.

<img loading="lazy" src='/assets/images/kane-ai/features/mobile-accessibility/accessibility-screenshot.png' alt="accessibility-screenshot" />
