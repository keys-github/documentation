...
sidebarTitle: "Test Manager Integration"
...
keywords: ['kane cli tms', 'kane cli test manager', 'kane cli upload', 'kane cli code export', 'kaneai', 'testmu ai']
"og:description": "Kane CLI uploads every session to TestMu AI Test Manager as a test case. Learn about the upload pipeline, project and folder selection, code export, share links, and session history."
---
