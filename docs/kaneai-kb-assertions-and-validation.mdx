...
sidebarTitle: "Assertions & Validation"
---
...
<Info>
For the full list of JS execution options, see [JS Snippets](/docs/kane-ai-javascript-execution) guide.
</Info>
