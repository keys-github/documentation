...
sidebarTitle: "Mobile App Testing Patterns"
---
...
1. Open LambdaTest **App Live** with the [UI Inspector](https://www.lambdatest.com/docs/ui-inspector/)
...
<Tip>
Deep links are excellent for test setup — jump directly to the screen you want to test instead of navigating through the entire app flow. See [Deep Link Support](/docs/kane-ai-deeplink-support).
</Tip>
...
See [Network Throttling](/docs/kaneai-network-throttling) for configuration.
...
See [Geolocation Testing](/docs/kane-ai-geolocation-tunnel-proxy).
