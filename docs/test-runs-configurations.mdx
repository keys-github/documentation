...
"og:description": "Learn how to create, manage, and apply reusable environment configurations for your test runs in LambdaTest Test Manager."
---
...
| **Custom ID** | Links the configuration to an app uploaded via [API](/docs/application-setup-via-api/#upload-your-application) with a specific `custom_id` |
