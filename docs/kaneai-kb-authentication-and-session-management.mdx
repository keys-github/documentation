...
sidebarTitle: "Authentication & Session Management"
---
...
<Tip>
You can find more information about environment variables in [this guide](/docs/kane-ai-using-variables/#environments).
</Tip>
...
For applications that require auth tokens in headers, use KaneAI's [Custom Headers](/docs/kaneai-custom-headers) feature:
