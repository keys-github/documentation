...
keywords: ['kane cli reference', 'kane cli commands', 'kaneai', 'testmu ai', 'cli flags']
"og:description": "Complete command and flag reference for Kane CLI: all commands, options, exit codes, TUI slash commands, keyboard shortcuts, and directory structure."
---
...
See [Authentication](/docs/kane-cli-authentication/) for details on profiles and auth methods.
...
See [Authentication — Profiles](/docs/kane-cli-authentication/#profiles) for details.
...
See [Configuration](/docs/kane-cli-configuration/) for the full settings reference.
...
Settings are stored at `~/.testmuai/kaneai/tui-config.json`. See [Configuration](/docs/kane-cli-configuration/) for details.
