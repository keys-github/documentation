...
url: https://www.testmuai.com/support/docs/playwright-junit-on-hyperexecute/
site_name: TestMu AI
      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "item": `${BRAND_URL}/support/docs/playwright-junit-on-hyperexecute/`
        }]
      })
    }}
></script>
...
- [**Using Local System**](/support/docs/playwright-junit-on-hyperexecute/#1-testing-using-local-system) - You can use your own local machine to execute tests.
- [**Using Gitpod Platform**](/support/docs/playwright-junit-on-hyperexecute/#2-testing-using-gitpod) -  Execute tests using GitPod. (Requires a [Gitpod](https://gitpod.io/login/) account)
...
<a href="https://github.com/LambdaTest/hyperexecute-java-playwright-sample.git" className="github__anchor"><img loading="lazy" src={require('../assets/images/icons/github.png').default} alt="Image" className="doc_img"/> View on GitHub</a>
