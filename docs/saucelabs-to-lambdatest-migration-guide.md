...
canonical: https://www.testmuai.com/support/docs/saucelabs-to-testmu-migration-guide/
---
...
***
## Authentication
Firstly, you need to change the authentication in your configuration settings of your test suite. For running tests on <BrandName /> Selenium Grid, you need to have a valid user_name and access_key to perform tests on our Grid. In case you do not have an account on <BrandName />, visit the <a href="https://testmuai.com/register/" onClick={CookieTrackingSignup}><BrandName /> signup page</a> and create a new account.
