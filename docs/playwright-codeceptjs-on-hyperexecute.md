---
id: playwright-codeceptjs-on-hyperexecute
title: Run playwright automation tests on HyperExecute using CodeceptJs
hide_title: true
sidebar_label: CodeceptJs
description: Learn how to run playwright automation tests on HyperExecute using CodeceptJs framework
keywords:
  - unittest
  - unittest selenium
  - python selenium
...
url: https://www.testmuai.com/support/docs/playwright-codeceptjs-on-hyperexecute/
site_name: TestMu AI
slug: playwright-codeceptjs-on-hyperexecute/
---
      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "@type": "ListItem",
          "position": 3,
          "name": "How to run playwright automation tests on HyperExecute using CodeceptJs framework",
          "item": `${BRAND_URL}/support/docs/playwright-codeceptjs-on-hyperexecute/`
        }]
      })
    }}
></script>
...
- [**Using Local System**](/support/docs/playwright-codeceptjs-on-hyperexecute/#1-testing-using-local-system) - You can use your own local machine to execute tests.
- [**Using Gitpod Platform**](/support/docs/playwright-codeceptjs-on-hyperexecute/#2-testing-using-gitpod) -  Execute tests using GitPod. (Requires a [Gitpod](https://gitpod.io/login/) account)
