...
sidebarTitle: "Finding & Interacting with Elements"
---
...
<Note>
**Bad approach:** `click on Add to Cart` — KaneAI won't know which product you mean.
</Note>
...
<Info>
See the [JS Snippets & Workarounds](/docs/kaneai-kb-js-snippets-and-workarounds) guide for a comprehensive list of scenarios where JS scripting is the recommended approach.
</Info>
