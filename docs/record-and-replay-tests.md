...
2. Login to your <BrandName /> Account via LT Debug Dashboard. Don't have an account, <a href="https://testmuai.com/register/" onClick={CookieTrackingSignup}>sign up for free</a>.
