...
"og:description": "Learn how to test drag and drop interactions in KaneAI using natural language commands and manual recording for complex web interactions."
---
