...
url: https://www.testmuai.com/support/docs/axosoft-integration/
site_name: TestMu AI
...
**Step 1:** Log in to your <a href="https://testmuai.com/register/" onClick={CookieTrackingSignup}><BrandName /> account</a>. You need to have Admin or User level access to see and install 3rd party integrations.
