...
sidebarTitle: "Advanced Mobile Features"
tag: "Mobile"
keywords: ['testmu ai automation', 'testmu ai kaneai', 'kaneai mobile app', 'biometrics','image injection','video injection']
---
...
<img loading="lazy" src='/assets/images/kane-ai/mobile-app-features/image1.jpg' alt="Image" />
...
You need to ensure to enable it from advanced settings before authoring your test on KaneAI. You can find more details about this capability [here](/docs/disable-screenshot-block/).
...
You can find more details about this capability [here](/docs/biometric-authentication/).&#x20;
...
You can find more details about this capability [here](/docs/camera-image-injection/).

<img loading="lazy" src='/assets/images/kane-ai/mobile-app-features/image2.jpg' alt="Image" />
...
You can find more details about this capability [here](/docs/video-injection/).
