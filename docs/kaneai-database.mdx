...
keywords: ['database', 'sql', 'nosql', 'gcp spanner']
"og:description": "Guide for usage of Database connection in KaneAI"
---
...
<img loading="lazy" src='/assets/images/kane-ai/features/create_database.png' alt="create-database" />
...
<img loading="lazy" src='/assets/images/kane-ai/features/create_database_list.png' alt="create-database-list" />
...
<img loading="lazy" src='/assets/images/kane-ai/features/create_database_gcp_spanner.png' alt="create-database-list" />
...
For local or private databases, select a tunnel if your tunnel is active. The tunnel can be activated easily by following the details available [here](/docs/kane-ai-geolocation-tunnel-proxy/#tunnel-support). Test the connection and create it to see the sample database added.
...
<img loading="lazy" src='/assets/images/kane-ai/features/database-slash-command.jpg' alt="create-database" />
...
<img loading="lazy" src='/assets/images/kane-ai/features/database-modal.jpg' alt="create-database" />
