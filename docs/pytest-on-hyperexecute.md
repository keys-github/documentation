---
id: pytest-on-hyperexecute
title: Run playwright automation tests on HyperExecute using PyTest framework
hide_title: true
      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "@type": "ListItem",
          "position": 3,
          "name": "How to run playwright automation tests on HyperExecute using Pytest framework",
          "item": `${BRAND_URL}/support/docs/pytest-on-hyperexecute/`
        }]
      })
    }}
></script>
...
This guide details how to execute your **PyTest** framework tests on **HyperExecute** via two different methods:

- [**Using Local System**](/support/docs/pytest-on-hyperexecute/#1-testing-using-local-system) - You can use your own local machine to execute tests.
- [**Using Gitpod Platform**](/support/docs/pytest-on-hyperexecute/#2-testing-using-gitpod) -  Execute tests using GitPod. (Requires a [Gitpod](https://gitpod.io/login/) account)
...
<a href="https://github.com/LambdaTest/hyperexecute-playwright-pypi-sample.git" className="github__anchor"><img loading="lazy" src={require('../assets/images/icons/github.png').default} alt="Image" className="doc_img"/> View on GitHub</a>
...
[<img alt="Run in Gitpod" width="200 px" align="center" src="https://user-images.githubusercontent.com/1688653/165307331-fbcf16b0-ce49-40f5-9f87-4f080d674624.png" />](https://hyperexecute.lambdatest.com/hyperexecute/jobs?type=gitpod&frameworkType=PlayWright&framework=PyTest)
