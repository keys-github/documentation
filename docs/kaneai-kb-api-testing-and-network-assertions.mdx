...
sidebarTitle: "API Testing & Network Assertions"
---
...
<Note>
Network log assertions are currently only supported on desktop web authoring in KaneAI. You can find more details in [Network Logs Assertion](/docs/kane-ai-network-assertions/) guide.
</Note>
...
For database testing details, see [Database Connections](/docs/kaneai-database).
