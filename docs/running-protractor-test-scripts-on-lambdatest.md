...
title: Selenium With Protractor
...
keywords:
  ...
  - protractor parallel testing selenium
  - protractor automation setup guide
...
<a href="https://github.com/LambdaTest/protractor-selenium-sample" className="github__anchor" target="_blank"><img loading="lazy" src={require('../assets/images/icons/github.png').default} alt="Image" className="doc_img"/> View on GitHub</a>
</div>
:::
