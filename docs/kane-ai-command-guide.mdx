...
keywords: ['testmu ai automation', 'testmu ai kaneai', 'kaneai guided walkthrough', 'kane ai instructions', 'kane ai commands']
"og:description": "Master KaneAI commands to automate web actions like navigation, clicking, typing, and more. Create dynamic, readable test cases with ease"
---
...
<img loading="lazy" src='/assets/images/kane-ai/knowledge-base/commands/select_set_timeout.webp' alt="" />
...
- **Switch to <BrandName /> tab:** Switch to the tab named "<BrandName />", regardless of its position in the tab order.
...
- **Close <BrandName /> tab:** Closes the tab named "<BrandName />". This is useful when you’ve finished interacting with a specific page and want to clean up the session.
...
More info: [Failure Conditions](/docs/kaneai-failure-conditions)  
</Note>
