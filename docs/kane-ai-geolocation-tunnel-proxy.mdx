...
"og:description": "Learn how to run your web tests on KaneAI using geolocation, tunnel, and dedicated proxy configurations."
---
...
<img loading="lazy" src='/assets/images/kane-ai/geolocation.png' alt="Image" width="1200" height="550" />
...
**Step 1 :** Configure the tunnel using the [LT tunnel binary](/docs/testing-locally-hosted-pages/#lambdatest-tunnel-guide) with `--env ht-prod` mode enabled. You can use the following command to trigger your tunnel:
...
<img loading="lazy" src='/assets/images/kane-ai/dedicated-proxy.png' alt="Image" width="1200" height="550" />
