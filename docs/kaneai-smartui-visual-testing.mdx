...
keywords: ['testmu ai kaneai', 'kaneai', 'smartui', 'visual testing', 'visual regression', 'automation']
"og:description": "A step-by-step guide on using KaneAI to automate visual regression tests. Learn to capture screenshots, establish baselines, compare visual changes with SmartUI, and schedule automated runs."
---
...
<img loading="lazy" src='/assets/images/kane-ai/smartui/kane-dashboard.png' alt="KaneAI Dashboard" />
...
<img loading="lazy" src='/assets/images/kane-ai/smartui/initiate-web-test.png' alt="Initiate a Web Test in KaneAI" />

### Add a Visual Comparison Step
Author your test by writing steps in plain language, such as `go to testmu ai`.
...
<img loading="lazy" src='/assets/images/kane-ai/smartui/add-visual-comparison-step.png' alt="Add Visual Comparison Step" />
...
<img loading="lazy" src='/assets/images/kane-ai/smartui/configure-screenshot.png' alt="Configure Screenshot Settings" />
...
<img loading="lazy" src='/assets/images/kane-ai/smartui/establish-baseline.png' alt="Baseline screenshot created" />
...
<img loading="lazy" src='/assets/images/kane-ai/smartui/analyze-comparison.png' alt="Analyze the visual comparison between baseline and new screenshot" />
...
<img loading="lazy" src='/assets/images/kane-ai/smartui/approve-reject-changes.png' alt="Approve or Reject Screenshot Changes" />
...
<img loading="lazy" src='/assets/images/kane-ai/smartui/save-test-case.png' alt="Save the test case session" />

<img loading="lazy" src='/assets/images/kane-ai/smartui/saved_test.png' alt="Save the test case session" />

### Execution and Scheduling

Once your test case is saved, navigate to the **Test Runs** tab to configure and launch its execution. For a complete guide on the initial setup, refer to our documentation on [Test Run Execution](/docs/kaneai-hyperexecute-test-run-execution/).
...
<img loading="lazy" src='/assets/images/kane-ai/smartui/run-test.png' alt="Run Test for automation" />

* **Schedule Test Run**
This option allows you to automate your visual regression testing by setting up a recurring schedule. Learn more in our guide to [Scheduled Test Runs](/docs/kaneai-scheduled-test-runs/).

<img loading="lazy" src='/assets/images/kane-ai/smartui/schedule-test-run.png' alt="Schedule the Test Run for automation" />
...
<img loading="lazy" src='/assets/images/kane-ai/smartui/advanced_config.png' alt="Schedule the Test Run for automation" />
...
<img loading="lazy" src='/assets/images/kane-ai/smartui/visual_config.png' alt="Schedule the Test Run for automation" />

For a more flexible usage you may use the **JSON** tab where you can set your own parameters and configuration.

<img loading="lazy" src='/assets/images/kane-ai/smartui/visual_configs_json.png' alt="Schedule the Test Run for automation" />
