...
sidebarTitle: "Dynamic URL Replacement"
description: "This documentation will help you to understand how to dynamically update your URL during the KaneAI testing"
keywords: ['modules versioning', 'enhancements', 'modules', 'dynamic url']
"og:description": "This documentation will help you to understand how to dynamically update your URL during the KaneAI testing"
---
...
## Prerequisites
You must have [created a test run for KaneAI Generated Tests](/docs/kaneai-hyperexecute-test-run-execution/).
...
<img loading="lazy" src='/assets/images/kane-ai/features/dynamic-url-replacement/1.png' alt="Image" />
...
<img loading="lazy" src='/assets/images/kane-ai/features/dynamic-url-replacement/2.png' alt="Image" />
