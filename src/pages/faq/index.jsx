...
// Brand name constant for inline text substitution
...
<details>
              <summary>Would I need to install a software or extension to use {BRAND_NAME} virtual machines?
              </summary>
              <p>No. You don't need to install any software or extension or plugin or setting configurations of any type. Just need to login to {BRAND_NAME}, open the virtual machine through launcher, and start testing. That's the beauty of cloud. It gets you started super quick.</p>
              </details>
              <details>
              ...
              <details>
              <summary>How much time it takes {BRAND_NAME} to add new browser version when it's released?
              </summary>
              ...
              <p>The number of sessions is limited by number of sessions running by a organization, not by user. Therefore it is entirely possible that you reach out of session limit even if only one or two users are using {BRAND_NAME} tool. Co-ordinate with your teammates in this case. If you are sure there is session issue from our end, you can raise a ticket at our support portal. Don't worry, we have a very fast turnaround time.</p>
              </details>
              <details>
              <summary>What happens when I leave the session idle?
              </summary>
              <p>By default, if you leave the Lamdatest Live session idle for 5 minutes, the app will prompt a reminder. If no action is taken then {BRAND_NAME} would close the live session. You can change this setting from Live settings options. Checkout this link to understand more about it.</p>
              </details>
              <details>
              <summary>What happens when I switch to another tab in my browser?
              </summary>
              <p>Switching tab won't stop or pause the Live session. If left idle for 5 minutes or more, {BRAND_NAME} will prompt a reminder and if unanswered will close the session.</p>
              </details>
              <details>
              <summary>When you give the machine to somebody else would they be able to access my history and saved passwords?
              </summary>
              <p>The moment you close the session, {BRAND_NAME} automatically sanitize the whole virtual machine. What that means is that we delete all historical data, downloads, installed extensions, saved passwords, etc. We reset the browsers to factory settings. This automatically logs you out of all pages and auto deletes all data that you may have saved. You would still have access to screenshots and issues you may have generated during the session.</p>
              </details>
              <details>
              ...
              {BRAND_NAME} test flagged the IP for excessive spam registrations. {BRAND_NAME} flagged the IP for violating terms of use or privacy policy To prevent our system from spam or security threats
              ...
              <p>{BRAND_NAME} test system allows only a limited number of concurrent running sessions per organization. This limit is defined by the plan that you have subscribed. If you need more concurrent sessions, you can change your plan, or contact one of our sales executive.</p>
              </details>
              <details>
              <summary>I found a bug and now I want to take a screenshot of the webpage running on {BRAND_NAME} real time browser. How can I do that? Where are they saved?
              </summary>
          ...
          {activeTab === 'developer' && (
            <div className={faqStyles.accordionGroup}>
<details>
              <summary>What developer tools come pre-installed in each {BRAND_NAME} Live remote session browser?
              </summary>
              <p>{BRAND_NAME} Live has all major developer debugging tools like Firebug, Web Developer, YSlow etc.</p>
              </details>
              <details>
              <summary>Can I install any additional tool that I like
              </summary>
              <p>Yes! You have full access to browser extensions and therefore can install any additional tool you like. However that tool be deleted once you close the Live session and you would have to reinstall it again in next session to use. If you are facing any problem around installing a tool on browser, raise an issue in {BRAND_NAME} Support portal and we would be glad to help you out.</p>
              </details>
            </div>
          )}
...
<details>
              ...
              <p>The {BRAND_NAME} Selenium grid doesn’t identify if you test ‘passed’ or ‘failed’. It only identifies whether a test has executed to it’s last command or whether it has stopped/timed-out before it. The user would have to pass on these parameters to {BRAND_NAME} platform to make it possible for tracking these values at {BRAND_NAME} platform. Make use of {BRAND_NAME} API or {BRAND_NAME} Annotations, for pushing additional metadata to {BRAND_NAME} or to track the pass/fail status of a test.</p>
              </details>

              <details>
              <summary>Can I Run Parallel Testing using JUnit Framework?
              </summary>
              <p>Yes! One of the key features of {BRAND_NAME} Selenium grid is the ability to run your test cases in parallel. Which means you can execute numerous automation test cases altogether and enable you to cut down on test times. With {BRAND_NAME} Selenium grid you can run a single test scenario across different browsers or different test scenarios with the same browser (or any other combinations). Wondering how many parallel test cases can you run? That depends entirely on the number of concurrent sessions under your opted plan.</p>
              </details>

              <details>
              <summary>What Is The Maximum Queuing Capacity?
              </summary>
              <p>Maximum number of test cases that can be queued = n + 150 Here, n = number of concurrent sessions. For instance, if you are opting for pricing where you can avail up to 10 concurrent sessions. Then the maximum number of test cases that can be queued will be equal to 10 + 150 i.e. 160 queued test cases. {BRAND_NAME} would automatically schedule and execute test cases for you.

              We have added a capacity constraint on the number of tests that can be queued to prevent over-exploitation of the platform. Refer {BRAND_NAME} Queuing Policy to know more.</p>
              </details>
              ...
              <p>To interact with a browser manually in an automation test, you can visit the {BRAND_NAME} Automation dashboard and then click on <b>Click to view live test</b> to take control of the browser.
              </p>
              </details>
...
<details>
              ...
              <p>Every time you run a test via the HyperExecute CLI, a hyperexecute-cli.log file is generated. It is present in the parent directory of your test and contains the details of your entire test run. This hyperexecute-cli.log file will also help you in debugging any issues with your tests. You can view the file and figure out exactly where your test run failed. If you want more help with debugging your issues, you can always contact support@lambdatest.com and provide them with this file along with your Job ID.</p>
              </details>
                </div>
              )}
              {activeHyeTab === 'feat' && (
...
<details>
              ...
              <details>
              <summary>Can I use the standard {BRAND_NAME} automation platform with the HyperExecute license?
              </summary>
...
<details>
              ...
              <p>{BRAND_NAME} comes with enterprise level local tunneling features. You can connect your local or production servers with {BRAND_NAME} Servers via secure SSH protocols and test your secure pages easily.</p>
              </details>
              <details>
              <summary>What happens when I switch tabs during when screenshots are being generated?
              </summary>
              <p>{BRAND_NAME} won't stop or pause the screenshot generation process. {BRAND_NAME} Automated Screenshot feature will generate screenshots and then will wait for your further actions.</p>
              </details>
            </div>
          )}
          ...
          {activeTab === 'responsive' && (
            <div className={faqStyles.accordionGroup}>
<details>
              <summary>What type of file formats does {BRAND_NAME} Realtime Native App testing support??
              </summary>
              ...
              <details>
              <summary>How long does my app remain uploaded on {BRAND_NAME} cloud?
              </summary>
              ...
              <p>Emulators on which App testing is performed work on the x86 architecture. Hence, your .apk file should be built for x86 architecture to ensure seamless testing on {BRAND_NAME} platform.</p>
              </details>
              <details>
          ...
          {activeTab === 'realdevice' && (
            <div className={faqStyles.accordionGroup}>
              ...
              <details>
              <summary>What test automation frameworks are supported by {BRAND_NAME} for App automation?
              </summary>
              ...
              <p>Currently, the Charles proxy for network traffic monitoring is not supported on {BRAND_NAME}.</p>
              </details>
              <details>
              <summary>What logs are available for debugging test failures ?
              </summary>
              <p>For debugging test failures, {BRAND_NAME} App testing supports Appium logs, Visual logs, Device logs, Network logs, and Command logs.</p>
              </details>
              <details>
              <summary>How can I test locally hosted or private app URLs?
              </summary>
              <p>You can test locally hosted and apps behind firewall by performing local testing through {BRAND_NAME} tunnel.</p>
              </details>
              <details>
              <summary>Do you support Network throttling?
              </summary>
              <p>Yes. Network throttling is supported on {BRAND_NAME} real device cloud platform.</p>
              </details>
              <details>
              ...
              <p>As of now, the dedicated devices are not supported on the {BRAND_NAME} platform.</p>
              ...
              <details>
              <summary>What is ADB? Does {BRAND_NAME} support ADB commands execution?
              </summary>
              <p>ADB (Android debug bridge) is a command-line tool for communicating with Android devices. The ADB command enables a variety of device actions, like installing apps, granting permissions, copying files, performance profiling, and so on.<br />We do not expose the ADB shell to protect the security of devices and users. However, the same functionality can be achieved by using an equivalent Appium capability or {BRAND_NAME} customer capabilities.
              </p>
              </details>
              ...
              <details>
              <summary>How do I resolve the localhost URL when using the {BRAND_NAME} tunnel?
              </summary>
              ...
              <details>
              <summary>Can I test my smart device (similar to Amazon Alexa) on {BRAND_NAME} platform with Real device? Also, I would need to connect this smart device with the Bluetooth of your mobile devices. Is this applicable?
              </summary>
              <p>This use case is not feasible at the moment as we do not support testing of Smart devices(Amazon Alexa) on the {BRAND_NAME} platform.
              </p>
              </details>

              <details>
              <summary>Can I test video calls on {BRAND_NAME} real devices?
              </summary>
              <p>Yes, you can test video calling apps on {BRAND_NAME}'s Real Devices but as the Camera is taped due to security reasons so it will show black image and audio will be blank as well.
              </p>
              </details>
...
<details>
              ...
              <p>{BRAND_NAME} is a firm believer in secure experience and multifaceted security protocols, to ensure that every aspect including architecture, engineering, testing, and deployment, follows and complies with industry leading standards of security. As first line of defense, {BRAND_NAME} application is protected by AWS&#8217;s firewalls which are tasked with countering regular DDoS attacks and malicious network intrusions. The next line of defense is {BRAND_NAME}&#8217;s own application firewall protocols which are tasked with protecting the application against spam, ill-intent users, and malicious IP. We have also implemented secure user access policies for accessing {BRAND_NAME} platform and only users with valid user credentials can access the application. We have also implemented role based access to the application, each role having different access levels.</p>
              <p>Whenever a user initiates a test at {BRAND_NAME} platform, they are allotted a thoroughly sanitized virtual machine. And as soon as a session ends, all data including cookies, registry, caches, and running processes are deleted and all browser settings are reset to default values. Each virtual machine has to pass a series of automated tests before it is used again. Any machine that fails a test gets redacted from the pool for auditing and manual cleaning. At the time of test only the user has access to machine and not even {BRAND_NAME} has access to the user&#8217;s running test session. All machines have strict security protocols that prohibit any user from installing any external software in the machines.</p>
              ...
              <p>We have implemented strict 24&#215;7 security protections at our on-premise development centers. Only authorized individuals have access to building and {BRAND_NAME} office premises. Our application data is hosted on industry leading hosts like Amazon Web Services, who have been thoroughly tested by multiple third party auditors for security. You can also read more about Amazon Web Service&#8217;s Security <a href="https://aws.amazon.com/security/">AWS Cloud Security</a></p>
              </details>
              <details>
              <summary>Do you have a disaster recovery (DR) or Business Continuity Plan (BCP) plan? How often is it tested?</summary>
              <p>{BRAND_NAME} has a formal Business Continuity Plan (BCP) and Disaster Recovery Plan (DRP) defined and implemented to enable people, process, and technology support during any crisis or business interruptions. The BC and DR Plan is tested and reviewed on a yearly basis.
              ...
              <ol>
              <li><b>4-hour Recovery Time Objective (RTO)</b>: {BRAND_NAME} will aim to restore normal operations for your {BRAND_NAME} platform account within four hours from the time a disaster is declared, unless a disaster, or multiple disasters, impacts all of the Availability Zones used on an account.</li>

              <li> <b>Under 1-hour Recovery Point Objective (RPO)</b>: {BRAND_NAME} will target one hour or less of data loss for your account. This is calculated from the point of the disruption, not from {BRAND_NAME}’s disaster declaration.</li><br />
              ...
              <p> Yes. All our employees sign confidentiality agreements which extends to user agreements between {BRAND_NAME} and Clients. Also, we have strict user role based access to all our customer data therefore, only most important employees have access to only relevant data.</p>
              </details>
              <details>
              ...
              <p>Access to production system is strictly controlled though role based authentication access. No {BRAND_NAME} employee has complete access to all data, each having their relevant role based access to data. Each employee has his/her own email based authentication passwords for accessing applications and after termination we revoke their complete access to the application. In addition we maintain automated logs of each database ingress and regularly monitor the logs to find discrepancies.</p>
              </details>
              <details>
              ...
              <p>At {BRAND_NAME}, we maintain a variety of logs such as syslog (system logs), auth (authentication) logs, firewall logs, web server logs, application server logs, database server logs, netflows etc. We have an inhouse implementation of ELK stack for logging and business intelligence. Our implementation gathers and consolidates data from all micro-applications into a secure private network. The data is used for product analysis by product team through our custom log processing and BI system. The BI system in turn is secured thorugh a IP based access policy. In addition only authorized {BRAND_NAME} employees has access to relevant pieces of data based on their role. All log data is saved in encrypted format private storage volumes that is encrypted usign DM-Crypt disk encryption system</p>
              </details>
              <details>
              ...
              <p>We, here, at {BRAND_NAME} follow a 6 step incident reponse process. The various stages of the response proces are prepration, identification, containment, eradication, recovery, and learning. We use industry leading practices for each step and test our response workflow once a month.</p>
              </details>
              <details>
              ...
              <details>
              <summary>{BRAND_NAME} Tunnel connects your servers with my system. How much of our local PC is exposed to your system?</summary>
              <p>None. Only web requests initiated on {BRAND_NAME} platform are transported to your localsystem via SSH tunnel created by our tunnel binary. The data at rest and data at transit are both encrypted. Only web browsing data generated by a  webbrowser selected on {BRAND_NAME} platform can send data to your system. As such your system is not exposed to public. In addition, every tunnel created using Lambda Tunnel binary is isolated to users of the same account. All Information of the remote tunnel is secured by accesstoken and we employ latest technology in encrypted tokens. This information is only provided to the browser fired the user. With that said, {BRAND_NAME} recommends using test data instead of production data as best practice.</p>
              </details>
            </div>
          )}
...
<details>
              ...
              <p>When you sign up with {BRAND_NAME}, you receive 60 mins/month Realtime Browser Testing (6 Sessions of 10 minutes each), 100 Automation Minutes for 15 days, 10 Screenshot Tests per month, 10 Responsive Tests per month, 24x7 Support, and 3rd Party App Integrations. The Free Trial is the best way to get a feel for {BRAND_NAME} and how it works. {BRAND_NAME} is ideal for teams, and therefore you can invite any number of users to be part of your {BRAND_NAME} Team for testing.</p>
              </details>

              <details>
              <summary>How does the FREE trial work?
              </summary>
              <p>When you sign up, you instantly get access to our Freemium plan. This plan has no trial time limit, it's there for you for Life. In the freemium plan you get 60 minutes of {BRAND_NAME} Live testing usage which gets renewed per month. You can anytime upgrade your plan for more robust features and unlimited access to {BRAND_NAME} Live Testing machines.</p>
              </details>
              ...
              <p>{BRAND_NAME} price is based on plan level and the no. of parallel sessions. As per your need you can upgrade and downgrade at any time. However, changes will not take effect until your next billing cycle.</p>
              </details>
            </div>
          )}
