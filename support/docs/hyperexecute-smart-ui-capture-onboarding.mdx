...
"og:description": "Complete step-by-step guide to get started with SmartUI Capture on HyperExecute for visual regression testing. Learn setup, configuration, best practices, and troubleshooting."
---
...
<a href="https://github.com/LambdaTest/smartui-playwright-sample" target="_blank" className='github__anchor'><img loading="lazy" src='/assets/images/icons/github.png' alt="Image" /> View on GitHub</a>
</Tip>
