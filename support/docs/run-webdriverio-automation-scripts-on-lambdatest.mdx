...
"og:description": "Now you can run your automation scripts using Selenium with WebDriverIO on TestMu AI online grid of 3000+ real desktop browsers and real operating systems."
---
...
**Step 1:** Clone our repo to see the sample test case to run the first test on <BrandName />.
```bash
...
describe('TestMu AI Demo Test', function() {
  it('TestMu AI Demo TestCase', function () {
    browser
      .url('https://lambdatest.github.io/sample-todo-app/')
      .click('*[name="li1"]')
      .click('*[name="li2"]')
      .setValue('*[id="sampletodotext"]','TestMu AI\n');
...
You can use **[<BrandName /> Capabilities Generator tool](https://www.testmuai.com/capabilities-generator/)** to select and pass those browser environment specifications.
...
//package.json
{
  "name": "webdriverio-selenium-sample",
  "version": "0.1.0",
  "readme": "WendriverIO Integration with [TestMu AI](https://www.TestMu AI.com)",
  "description": "Selenium examples for WebdriverIO and TestMu AI Automate",
  "scripts": {
