...
//package.json
{
  ...
  "repository": {
    "type": "git",
    "url": "git+https://github.com/LambdaTest/webdriverio-TestMu AI.git"
  },
  "keywords": [
    "webdriverio",
    "TestMu AI",
  ...
  "bugs": {},
  "homepage": "https://github.com/LambdaTest/webdriverio-TestMu AI#readme",
  "dependencies": {
    "webdriverio": "^4.14.2"
  },
  "devDependencies": {
