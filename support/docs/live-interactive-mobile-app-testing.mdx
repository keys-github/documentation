...
sidebarTitle: "Realtime Native Mobile App Testing"
...
keywords: ['mobile app testing', 'testmu ai manual app testing', 'live-interactive mobile app testing testmu ai', 'geolocation app testing']
"og:description": "With TestMu AI, perform live interactive testing of mobile applications on Android emulators and iOS simulators and ensure your apps work seamlessly across multiple versions of Android emulators and iOS simulators."
---
...
<img loading="lazy" src='/assets/images/mobile-app-testing/native-app-testing-1.webp' alt="Native Mobile App Testing" width="1366" height="629" />

Your application will be uploaded successfully. Currently, you can upload `.apk` files up to 1GB.

<img loading="lazy" src='/assets/images/mobile-app-testing/native-app-testing-2.webp' alt="Native Mobile App Testing" width="1366" height="629" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/native-app-testing-3.webp' alt="Native Mobile App Testing" width="1366" height="629" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/native-app-testing-4.webp' alt="Native Mobile App Testing" width="1366" height="629" /> 

An Android emulator will fire up where you can perform native application testing of your mobile apps. 

<img loading="lazy" src='/assets/images/mobile-app-testing/Screenshot-239.webp' alt="Native Mobile App Testing" width="1366" height="629" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/Screenshot-240.webp' alt="Native Mobile App Testing" width="1366" height="629" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/Screenshot-241.webp' alt="Native Mobile App Testing" width="1366" height="629" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/Screenshot-244.webp' alt="Native Mobile App Testing" width="1366" height="629" /> Your bugs will be marked successfully.
...
<img loading="lazy" src='/assets/images/mobile-app-testing/Screenshot-245.webp' alt="Native Mobile App Testing" width="1366" height="629" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/Screenshot-246.webp' alt="Native Mobile App Testing" width="1366" height="629" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/Screenshot-247.webp' alt="Native Mobile App Testing" width="1366" height="629" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/ui-inspector-1.webp' alt="Native Mobile App Testing" width="1366" height="629" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/ui-inspector-2.webp' alt="Native Mobile App Testing" width="1366" height="629" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/Screenshot-250.webp' alt="Native Mobile App Testing" width="1366" height="620" /> 

After a few seconds, your keyboard language will be changed.

<img loading="lazy" src='/assets/images/mobile-app-testing/Screenshot-251.webp' alt="Native Mobile App Testing" width="1366" height="620" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/Screenshot-249.webp' alt="Native Mobile App Testing" width="1366" height="622" /> 

The device will be rotated successfully.

<img loading="lazy" src='/assets/images/mobile-app-testing/Screenshot-248.webp' alt="Native Mobile App Testing" width="1353" height="608" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/Screenshot-252.webp' alt="Native Mobile App Testing" width="1366" height="620" />

*   To put the device on sleep mode, click on <img loading="lazy" src='/assets/images/mobile-app-testing/sleep.webp' alt="Native Mobile App Testing" width="1366" height="622" /> icon.
*   To increase volume, click on <img loading="lazy" src='/assets/images/mobile-app-testing/vol_up.webp' alt="Native Mobile App Testing" width="1353" height="608" /> icon.
*   To decrease volume, click on <img loading="lazy" src='/assets/images/mobile-app-testing/vol_down.webp' alt="Native Mobile App Testing" width="1366" height="614" /> icon.
...
<img loading="lazy" src='/assets/images/mobile-app-testing/Screenshot-254.webp' alt="Native Mobile App Testing" width="1366" height="618" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/Screenshot-255.webp' alt="Native Mobile App Testing" width="1366" height="616" />
...
<iframe 
  width="560" 
  height="315" 
  src="https://www.youtube.com/embed/Y0GDCneEYGA" 
...
<img loading="lazy" src='/assets/images/mobile-app-testing/Screenshot-257.webp' alt="Native Mobile App Testing" width="1366" height="616" />

**Step 2**: Once you click on Install New, you will need to upload your app either via browser or a URL.

<img loading="lazy" src='/assets/images/mobile-app-testing/Screenshot-258.webp' alt="Native Mobile App Testing" width="1349" height="607" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/Screenshot-261.webp' alt="Native Mobile App Testing" width="1354" height="613" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/Screenshot-262.webp' alt="Native Mobile App Testing" width="1366" height="620" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/Screenshot-263.webp' alt="Native Mobile App Testing" width="1366" height="618" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/Screenshot-265.webp' alt="Native Mobile App Testing" width="1360" height="612" />

**Step 2**: A confirmation pop-up box will appear. Click on **'Yes, End Session'**.

<img loading="lazy" src='/assets/images/mobile-app-testing/Screenshot-266.webp' alt="Native Mobile App Testing" width="1366" height="616" />
