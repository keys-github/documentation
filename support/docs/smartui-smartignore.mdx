...
keywords: ['hide displacement diffs', 'ignore displacement differences', 'smart ignore layout shifts', 'ai based auto ignore']
"og:description": "Learn how to use our new comparison engine Smart Ignore to efficiently ignore noise, layout shifts and displacement differences in your visual tests"
---
...
<img loading="lazy" src='/assets/images/smart-visual-testing/smart-ignore/p2p.webp' alt="cmd" width="768" height="373" />
...
<img loading="lazy" src='/assets/images/smart-visual-testing/smart-ignore/smartignore.webp' alt="cmd" width="768" height="375" />
...
<img
  loading="lazy"
  src='/assets/images/smart-visual-testing/smart-ignore/Toggle.png'
  alt="cmd"
  width="300"
  height="200"
 />
...
<img
  loading="lazy"
  src='/assets/images/smart-visual-testing/smart-ignore/Dropdown-4.png'
  alt="cmd"
  width="300"
  height="200"
 />
...
<Tab title="Start with Project-Level Toggle">
...
<Tab title="Combine with Other Features">
...
<Tab title="Review Results Regularly">
...
<Tab title="Use Per-Screenshot Mode for Testing">
...
<Tab title="Smart Ignore Not Available">
...
<Tab title="Too Many Differences Still Shown">
...
<Tab title="Important Changes Hidden">
...
<Note>
: Smart Ignore is continuously being improved. Features like element ignoring and enhanced Project Settings integration are planned for future releases. Check the [release notes](/support/docs/) for updates.
</Note>
