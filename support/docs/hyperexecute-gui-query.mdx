...
sidebarTitle: "Search Query in GUI"
description: "This documentation outlines the steps on how to use search query in hyperexecute gui app."
keywords: ['TestMu AI', 'HyperExecute', 'TestMu AI HyperExecute', 'CLI', 'Search Query', 'Filter', 'HyperExecute-GUI', 'test execute', 'hyperexecute job', 'automation']
"og:description": "This documentation outlines the steps on how to use search query in hyperexecute gui app."
---
...
<source src= '/assets/videos/hyperexecute/cli-gui/writing_query.mp4' type="video/mp4" />
</video>
...
<video class="right-side" width="100%" controls id="vid">
<source src= '/assets/videos/hyperexecute/cli-gui/saving_query.mp4' type="video/mp4" />
</video>
