...
"og:description": "Learn how to test flutter apps for Appium testing across 3000+ real Android and iOS devices."
---
...
You can now test Flutter apps on the <BrandName /> <a href="https://www.lambdatest.com/appium-testing">Appium testing</a> platform across 3000+ real Android and iOS devices. <BrandName /> supports Appium's Flutter driver that lets you test Flutter apps using the Appium framework. To test Flutter apps, you will need to upload apps on <BrandName /> cloud servers and then run your automated tests. 
...
To run Appium tests using the Flutter Integration Driver on <BrandName />, set the *automationName* capability to *FlutterIntegration*.
...
Below is a screenshot showing Appium test automation running with the Flutter Integration Driver on the <BrandName /> platform.

<img loading="lazy" src='/assets/images/appium-flutter-integration-driver.webp' alt="Running Appium tests with Flutter Integration Driver on <BrandName />" width="1365" height="650" />
