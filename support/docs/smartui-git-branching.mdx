...
sidebarTitle: Storybook Git Baseline Branching
...
"og:description": "In this documentation, learn how the Git Branching Strategy is implemented in Visual Regression testing on the TestMu AI Automation Cloud across 40+ browser versions."
---
...
<img loading="lazy" src='/assets/images/smart-visual-testing/git-doc-header.webp' alt="Smart Visual Testing" width="1600" height="803" />
...
<Warning>
This feature is currently supported for only [**StoryBook**](/support/docs/smart-ui-storybook/) projects on the SmartUI platform. Please contact support@testmuai.com for further information or requests.
</Warning>
...
<img loading="lazy" src='/assets/images/smart-visual-testing/smartui-git-build-meta-data.webp' alt="Smart Visual Testing" width="1600" height="803" />
...
<img loading="lazy" src='/assets/images/smart-visual-testing/git-updating-baseline-branch.webp' alt="Smart Visual Testing" width="1600" height="803" />
...
<img loading="lazy" src='/assets/images/smart-visual-testing/git-compare-with-latest-build.webp' alt="Smart Visual Testing" width="1600" height="803" />
