...
keywords: ['testmu ai', 'web scanner', 'schedule scan', 'recurring scan']
"og:description": "A guide to the scheduling options available in Web Scanner, including one-time Quick Scans, recurring scans, and how to manage scheduled jobs."
---
...
<img loading="lazy" src='/assets/images/web-scanner/scheduling-options-ui.png' alt="Scheduling Options UI" />
...
<img loading="lazy" src='/assets/images/web-scanner/modify-visual-scan.png' alt="Modify a Scheduled Visual Scan" />
