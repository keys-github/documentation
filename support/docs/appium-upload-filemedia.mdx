...
sidebarTitle: "Upload Files and Media"
...
keywords: ['files upload', 'app test automation', 'media upload', 'upload automate', 'framework on testmu ai', 'app testing appium', 'app testing', 'real devices']
"og:description": "Seamlessly upload media and files on Real Devices to enhance your testing scenarios and ensure comprehensive validation of your application's functionalities."
---
...
### Step 1 : Uploading the files on <BrandName /> Cloud
...
You can also utilize <BrandName />'s user-friendly UI to upload the files on <BrandName /> cloud and get the `media_url` using the upload button located at the top of the automation dashboard.
