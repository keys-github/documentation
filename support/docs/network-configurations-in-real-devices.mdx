...
sidebarTitle: "Network Configurations"
...
keywords: ['testmu ai manual testing', 'network logs', 'mitm proxy', 'http traffic capture', 'domain filtering', 'network configurations']
"og:description": "Learn how to configure and capture HTTP/S traffic on real devices during manual testing in App Live & Browser Live, with options for content capture and domain filtering."
---
