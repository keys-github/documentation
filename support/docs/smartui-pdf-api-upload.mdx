...
sidebarTitle: "API Upload"
keywords: ['PDF API Upload', 'SmartUI API', 'Visual Regression Testing', 'PDF Testing', 'REST API']
"og:description": "Learn how to upload PDF files to SmartUI using the REST API for visual regression testing."
---
...
<Tab title="Upload Returns Error Response">
