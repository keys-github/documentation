...
## 1. Cypress Detailed Command Logs for Enhanced Debugging 
...
<img loading="lazy" src='/assets/images/hyperexecute/release-notes/detailed-cypress-logs.png' style={{width: '600px'}}  alt="HyperExecute" /> <br /><br />

<Note>
📕 Learn how to enable [Detailed Command Logs](/support/docs/cypress-detailed-command-logs/) for your Cypress tests.
</Note>

## 2. Parameterized Report Email Handling in YAML <span className="bg-yellow-600 text-white px-4 py-1 rounded-full text-xs text-nowrap">Enhancement</span> 
