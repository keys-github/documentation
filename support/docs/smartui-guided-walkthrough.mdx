...
keywords: ['TestMu AI SmartUI', 'TestMu AI SmartUI help', 'TestMu AI SamrtUI documentation', 'FAQs']
"og:description": "Learn how to manage tests, update the images, compare the images, perform testing using the dashboard."
---
...
<img loading="lazy" src='/assets/images/smart-visual-testing/guided-walkthrough/1.png' alt="Image" />
...
<img loading="lazy" src='/assets/images/smart-visual-testing/guided-walkthrough/2.png' alt="Image" />
