...
keywords: ['TestMu AI', 'Accessibility', 'Crawler', 'Testing', 'URL Extraction']
"og:description": "Learn how to use TestMu AI’s Crawler to automate URL extraction for accessibility testing. Configure crawl settings, include/exclude URL patterns, and analyze scan results."
---
...
<img loading="lazy" src='/assets/images/accessibility-testing/schedule-scan/crawler.png' />
