...
keywords: ['reqnroll', 'reqnroll selenium', 'reqnroll appium', 'reqnroll tutorial', 'c# selenium', 'c# automation testing', 'selenium webdriver c#', 'selenium c# testing tutorial', 'c# selenium framework']
"og:description": "Now you can run your automation scripts using Selenium with Reqnroll on TestMu AI online grid of 10000+ real desktop browsers and real operating systems."
---
...
<p align="center">
<img loading="lazy" src='/assets/images/uploads/reqnroll-virtual-environment.webp' alt="cmd" width="768" height="373" />
</p>
...
```
<p align="center">
<img loading="lazy" src='/assets/images/uploads/reqnroll-step4.webp' alt="cmd" width="768" height="373" />
</p>
...
```
<p align="center">
<img loading="lazy" src='/assets/images/uploads/reqnroll-step5.webp' alt="cmd" width="768" height="373" />
</p>
...
<p align="center">
<img loading="lazy" src='/assets/images/uploads/reqnroll-step6.webp' alt="cmd" width="768" height="373" />
</p>

<p align="center">
<img loading="lazy" src='/assets/images/uploads/reqnroll-step6.0.webp' alt="cmd" width="768" height="373" />
</p>
...
<p align="center">
<img loading="lazy" src='/assets/images/uploads/reqnroll-cloud-execution.webp' alt="cmd" width="768" height="373" />
</p>

As seen below, all the scenarios that are a part of respective *.feature(s)* files successfully executed on <BrandName />.

<p align="center">
<img loading="lazy" src='/assets/images/uploads/reqnroll-step7.webp' alt="cmd" width="768" height="373" />
</p>

<p align="center">
<img loading="lazy" src='/assets/images/uploads/reqnroll-step7.1.webp' alt="cmd" width="768" height="373" />
</p>
...
```
<p align="center">
<img loading="lazy" src='/assets/images/uploads/reqnroll-mobile-step1.webp' alt="cmd" width="768" height="373" />
</p>
...
<p align="center">
<img loading="lazy" src='/assets/images/uploads/reqnroll-mobile-step4.webp' alt="cmd" width="768" height="373" />
</p>

You would also see the app named 'proverbial-android' in the [App Live App Dashboard](https://applive.lambdatest.com/app).

<p align="center">
<img loading="lazy" src='/assets/images/uploads/reqnroll-mobile-step4.1.webp' alt="cmd" width="768" height="373" />
</p>
...
```
<p align="center">
<img loading="lazy" src='/assets/images/uploads/reqnroll-mobile-step5.webp' alt="cmd" width="768" height="373" />
</p>
...
```
<p align="center">
<img loading="lazy" src='/assets/images/uploads/reqnroll-mobile-step6.webp' alt="cmd" width="768" height="373" />
</p>
...
<p align="center">
<img loading="lazy" src='/assets/images/uploads/reqnroll-mobile-step7.webp' alt="cmd" width="768" height="373" />
</p>

<p align="center">
<img loading="lazy" src='/assets/images/uploads/reqnroll-mobile-step7.1.webp' alt="cmd" width="768" height="373" />
</p>

<p align="center">
<img loading="lazy" src='/assets/images/uploads/reqnroll-mobile-step7.2.webp' alt="cmd" width="768" height="373" />
</p>
...
<p align="center">
<img loading="lazy" src='/assets/images/uploads/reqnroll-mobile-step8.webp' alt="cmd" width="768" height="373" />
</p>
