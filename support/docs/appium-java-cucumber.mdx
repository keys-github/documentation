...
"og:description": "Test your Appium automation scripts using Java Cucumber on TestMu AI Real Device Cloud Platform of 3000+ real mobile devices."
---
...
All the code samples in this documentation can be found on **<BrandName />'s Github Repository**. You can either download or clone the repository to quickly run your tests. <GitHubButton url="https://github.com/LambdaTest/LT-appium-java-cucumber" />
</Tip>
