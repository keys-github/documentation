...
keywords: ['local app testing', 'testmu ai local testing', 'testmu ai local tunnel', 'TestMu AI tunnel', 'local app testing for Linux']
...
<img loading="lazy" src='/assets/images/local-testing-linux/local-linux-1.webp' alt="TCP with TLS 1.2 secure connection tunnel configuration" width="1346" height="622" />
...
<img loading="lazy" src='/assets/images/local-testing-linux/local-linux-2.webp' alt="Extracting downloaded binary file" width="1524" height="158" />
...
<img loading="lazy" src='/assets/images/local-testing-linux/local-linux-3.webp' alt="Start localhost testing on Linux" width="1522" height="167" />
...
<img loading="lazy" src='/assets/images/local-testing-linux/local-linux-4.webp' alt="Xampp Control Panel" width="664" height="416" />
...
<img loading="lazy" src='/assets/images/local-testing-linux/local-linux-5.webp' alt="realtime testing on locally hosted pages" width="1355" height="613" />
...
<img loading="lazy" src='/assets/images/local-testing-linux/local-linux-6.webp' alt="Local page testing configuration" width="1355" height="613" />

Once you press the **‘Start’**  button, your test will start and you will be navigated to your localhost URL.

<img loading="lazy" src='/assets/images/local-testing-linux/local-linux-7.webp' alt="start localhost test using xampp" width="1099" height="519" />
...
<img loading="lazy" src='/assets/images/local-testing-linux/local-linux-8.webp' alt="TCP with TLS 1.2 secure connection tunnel configuration" width="1342" height="608" />

**Step 2:**  Click on **‘Folder’**  button and copy the string on your system’s clipboard.

<img loading="lazy" src='/assets/images/local-testing-linux/local-linux-9.webp' alt="testing locally hosted folder" width="1343" height="559" />
...
<img loading="lazy" src='/assets/images/local-testing-linux/local-linux-10.webp' alt="test locally hosted website folder" width="1348" height="613" />
...
<img loading="lazy" src='/assets/images/local-testing-linux/folder2.webp' alt="Launching Virtual Machine" width="1125" height="544" />
...
<img loading="lazy" src='/assets/images/local-testing-linux/local-linux-12.webp' alt="Stopping TCP with TLS 1.2 secure connection Tunnel" width="1523" height="223" />
...
<img loading="lazy" src='/assets/images/local-testing-linux/local-linux-13.webp' alt="Disconnecting tunnel" width="1349" height="622" />
...
<img loading="lazy" src='/assets/images/local-testing-linux/local-linux-14.webp' alt="Access key generation" width="1344" height="617" />
...
<img loading="lazy" src='/assets/images/local-testing-linux/local-linux-15.webp' alt="Access key generation using command prompt" width="1343" height="620" />

You can also find your Access Key by going to **‘Settings’**  in the left navigation menu and routing to **‘Profile’**.

<img loading="lazy" src='/assets/images/local-testing-linux/local-linux-16.webp' alt="Finding access key in profile section" width="1348" height="618" />
