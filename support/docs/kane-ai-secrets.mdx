...
keywords: ['testmu ai automation', 'testmu ai kaneai', 'kaneai secrets', 'kaneai parameters']
"og:description": "Learn how to create, update and use custom secrets from the test manager and while executing your tests using the Kane AI"
---
...
<img loading="lazy" src='/assets/images/kane-ai/features/secrets/test-manager-secret.gif' /> 
...
<source src= '/assets/images/kane-ai/features/secrets/kane-ai-secret.mp4' type="video/mp4" />
</video>
...
<video class="right-side" width="100%" controls id="vid">
<source src= '/assets/images/kane-ai/features/secrets/use-secrets.mp4' type="video/mp4" />
</video>
...
<img loading="lazy" src= '/assets/images/kane-ai/features/secrets/update-secret.png' alt="Image" />
...
<img loading="lazy" src= '/assets/images/kane-ai/features/secrets/delete-secret.png' alt="Image" />
