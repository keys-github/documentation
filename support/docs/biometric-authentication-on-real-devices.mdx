...
"og:description": "Learn how to test biometric authentication in iOS and Android apps using TestMu AI's real device testing platform. Enhance app security and user experience."
---
...
<img loading="lazy" src='/assets/images/real-device-app-testing/biometric-authentication/biometric-authentication.png' />

**Step 4:** Once your session starts and biometric authentication is enabled for the app, use <BrandName />'s **Biometric Authentication** pop-up shown below to interact with any instance where biometric authentication is invoked.

<img loading="lazy" src='/assets/images/real-device-app-testing/biometric-authentication/biometric-ss.png' />
