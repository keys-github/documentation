...
keywords: ['TestMu AI HyperExecute', 'HyperExecute Workflows', 'schedule tests', 'connected workflows', 'test chains']
"og:description": "Schedule and orchestrate HyperExecute jobs without a full CI/CD, chain workflows across projects, and parameterize runs with workflow variables."
---
...
<source src= '/assets/videos/hyperexecute/workflow/workflow_vars.mp4' style={{ height: '300px' }} type="video/mp4" />
</video>
