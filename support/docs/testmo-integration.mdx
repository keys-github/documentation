...
sidebarTitle: "TestMo"
keywords: ['TestMu AI integration', 'testmu ai integration with testmo', 'testmu ai selenium grid integration to testmo']
"og:description": "TestMu AI integration to TestMo will help you run your automation scripts from TestMo instance to our cloud-based Grid."
---
...
- Create your account in [<BrandName />](https://accounts.lambdatest.com/dashboard) and [TestMo](https://manage.testmo.com/trial)
...
<img loading="lazy" src='/assets/images/testmo-integration/dashboard.webp' alt="provide access to <BrandName /> account" width="1280" height="684" />
...
testmo automation:run:submit --instance https://your_testmo_address.testmo.net \
  --project-id 1 --name "testmu ai" --source "frontend" --results \
  your_test_result_file_path.xml
```

- Output in the Dashboard

<img loading="lazy" src='/assets/images/testmo-integration/testmo-result.webp' alt="provide access to <BrandName /> account" width="1280" height="684" />
