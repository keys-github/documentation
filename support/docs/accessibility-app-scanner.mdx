...
"og:description": "TestMu AI Accessibility DevTools help automate detection and reporting of accessibility issues based on WCAG guidelines."
---
...
<img loading="lazy" src='/assets/images/accessibility-testing/app-automation/app-upload.png' alt="Image" className="doc_img img_center" />
...
<img loading="lazy" src='/assets/images/accessibility-testing/app-automation/1.png' alt="Image" className="doc_img img_center" />
<br />
...
<img loading="lazy" src='/assets/images/accessibility-testing/app-automation/2.png' alt="Image" className="doc_img img_center" />
...
<img loading="lazy" src='/assets/images/accessibility-testing/app-automation/3.png' alt="Image" className="doc_img img_center" />
...
<img loading="lazy" src='/assets/images/accessibility-testing/app-automation/4.png' alt="Image" className="doc_img img_center" />
