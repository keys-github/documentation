...
sidebarTitle: "Troubleshooting TestMu AI Tunnel"
...
keywords: ['troubleshooting testmu ai Tunnel', 'tunnel not connecting', 'localhost not reachable', 'connection refused']
"og:description": "This document will help you troubleshoot the most common challenges faced during local app testing using TestMu AI Tunnel."
---
...
If due to some unfortunate reason, you are unable to perform <a href="https://www.lambdatest.com">cross browser testing</a> using <BrandName /> Tunnel then this document will help you troubleshoot the most common challenges.
...
- [Localhost refused to connect](/support/docs/troubleshooting-lambda-tunnel/#1-localhost-refused-to-connect)
- [Invalid Host Header](/support/docs/troubleshooting-lambda-tunnel/#2-invalid-host-header)
- [WordPress - CSS not loading](/support/docs/troubleshooting-lambda-tunnel/#3-wordpress---css-not-loading)
- [IP whitelisting](/support/docs/troubleshooting-lambda-tunnel/#4-ip-whitelisting)
- [No available PORT found](/support/docs/troubleshooting-lambda-tunnel/#5-no-available-port-found)
- [Custom Host name](/support/docs/troubleshooting-lambda-tunnel/#6-custom-host-name)
- [CUI – Console UI](/support/docs/troubleshooting-lambda-tunnel/#7-still-got-issues-let-us-help-through-cuiconsole-ui)
- [Unable to establish a secure shell tunnel connection through Port 443](/support/docs/troubleshooting-lambda-tunnel/#8-unable-to-establish-a-secure-shell-tunnel-connection-through-port-443)
- [LT can’t be opened because Apple cannot check it for malicious software](/support/docs/troubleshooting-lambda-tunnel/#9-lt-cant-be-opened-because-apple-cannot-check-it-for-malicious-software)
...
<img loading="lazy" src='/assets/images/troubleshooting-lambda-tunnel/localhost-refused-to-connect.webp' alt="troubleshoot testmu ai tunnel" width="1600" height="750" />
...
<img loading="lazy" src='/assets/images/troubleshooting-lambda-tunnel/invalid-host-header.webp' alt="troubleshoot testmu ai tunnel" width="1600" height="754" />
...
<img loading="lazy" src='/assets/images/troubleshooting-lambda-tunnel/WordPress-CSS-Not-Loading.webp' alt="troubleshoot testmu ai tunnel" width="1600" height="753" />
...
<img loading="lazy" src='/assets/images/troubleshooting-lambda-tunnel/general-settings-for-troubleshooting-lambda-tunnel.webp' alt="troubleshoot testmu ai tunnel" width="1600" height="751" />
...
<img loading="lazy" src='/assets/images/troubleshooting-lambda-tunnel/hello-world.webp' alt="troubleshoot testmu ai tunnel" width="1600" height="758" />
...
<img loading="lazy" src='/assets/images/troubleshooting-lambda-tunnel/verbose.webp' alt="troubleshoot testmu ai tunnel" width="981" height="508" />
