...
<img loading="lazy" src='/assets/images/guide-to-php/guide-to-php-1.webp' alt="Xampp control pannelto start selenium php tests" width="682" height="440" />
...
/*
    ...
    Result
    -------
    Execute PHP Automation Tests on TestMu AI Distributed Selenium Grid
*/
