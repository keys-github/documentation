...
sidebarTitle: "Codefresh CI"
keywords: ['testmu ai integrations', 'continuous integration', 'codefresh', 'codefresh ci integration', 'testmu ai codefresh ci integration']
"og:description": "TestMu AI offers continuous integration with Codefresh to ease your automated cross browser testing process through their Selenium grid consisting more than 3000+ browsers."
---
...
<img loading="lazy" src='/assets/images/codefresh-integration/go_to_pipelines.png' alt="Sign up on Codeship" width="1365" height="650" />

**Step 2:** Select your user/git organisation, select repository and then click create.

<img loading="lazy" src='/assets/images/codefresh-integration/select_git.png' alt="Select GitHub as your SCM" width="1346" height="647" />

**Step 3:** After the creation of pipeline, you must see the workflow YAML got generated, with your selected github repository.

<img loading="lazy" src='/assets/images/codefresh-integration/workflow.png' alt="opt for Codeship Basic" width="798" height="415" />
...
<img loading="lazy" src='/assets/images/codefresh-integration/pipeline_ruuning.png' alt="opt for Codeship Basic" width="798" height="415" />
...
<img loading="lazy" src='/assets/images/codefresh-integration/lt_dash.png' alt="opt for Codeship Basic" width="798" height="415" />
...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        driver.find_element(By.ID, "sampletodotext").send_keys("TestMu AI")
        add_button = driver.find_element(By.ID, "addbutton")
        add_button.click()
        print("Added TestMu AI checkbox")
