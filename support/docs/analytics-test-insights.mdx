...
sidebarTitle: "Tests Insights"
keywords: ['analytics', 'test insights', 'test observability', 'test analytics', 'test performance', 'test failure classification']
"og:description": "Analytics - Tests Insights for analyzing the past results with the latest test runs"
---
...
## About Test Insights
<BrandName /> Analytics provides Test Insights, a powerful feature designed to help you analyze your test runs and gain valuable insights into your testing processes. With Test Insights, you can visualize your test runs, track progress, and improve the quality of your tests with actionable analytics.

## Prerequisites for Test Insights
1. **<BrandName /> Account**: You must have an active <BrandName /> account to access Test Insights.
2. **Subscription Plan**: Test Insights is available for users with the HyperExecute or App/Web Automation subscription plan.
3. **Test Execution Data**: You should have test execution data available in your <BrandName /> account. Test Insights analyzes this data to provide insights into your test runs.
4. **Access to Analytics**: Ensure you have access to the <BrandName /> Analytics platform to view and analyze your test insights.
...
Your Show Unique Instances preference is automatically saved, so you don't need to re-enable it each time you visit. Test Insights and Build Insights remember their settings independently, allowing you to configure each page to suit your workflow.
