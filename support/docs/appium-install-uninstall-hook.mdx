...
sidebarTitle: "Install/Uninstall app"
keywords: ['appium', 'testmu ai hooks', 'app automation', 'mobile test', 'app testing', 'real devices']
"og:description": "Now you can install or uninstall applications using hooks in your App Automation scripts that you run on TestMu AI."
---
