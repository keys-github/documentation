...
sidebarTitle: "Local Testing For Windows"
keywords: ['local testing', 'TestMu AI tunnel Features', 'local testing for windows', 'push issues to clubhouse', 'local cross browser testing']
...
| [DOWNLOAD <BrandName /> tunnel ZIP FOR WINDOWS 64 BIT](https://downloads.lambdatest.com/tunnel/v3/windows/64bit/LT_Windows.zip) |
|--------------------------------------------------------------------------------------------------------------------------|
...
<img loading="lazy" src='/assets/images/local-testing-windows/local-windows-1.webp' alt="tunnel configuration for localhost testing on winws" width="1346" height="622" />
...
<img loading="lazy" src='/assets/images/local-testing-windows/local-windows-2.webp' alt="extracting binary zip file" width="988" height="487" />
...
```
LT --user example@lambdatest.com --key 123456789abcdefghijklmnopqrstuv --tunnelName TestMu AI
```
<img loading="lazy" src='/assets/images/local-testing-windows/local-windows-3.webp' alt="Access key for tunnel activation" width="1179" height="472" />
...
<img loading="lazy" src='/assets/images/local-testing-windows/tunnel_launched.webp' alt="start localhost testing on Windows" width="970" height="313" />
...
<img loading="lazy" src='/assets/images/local-testing-windows/local-windows-5.webp' alt="Xampp Control Panel" width="970" height="313" />
...
<img loading="lazy" src='/assets/images/local-testing-windows/local-windows-6.webp' alt="realtime localhost testing" width="1355" height="613" />
...
<img loading="lazy" src='/assets/images/local-testing-windows/local-windows-7.webp' alt="local testing configuration" width="1355" height="613" />

Once you press the **‘Start’**  button, your test will start and you will be navigated to your localhost URL.

<img loading="lazy" src='/assets/images/local-testing-windows/local-windows-8.webp' alt="Starting Xampp" width="1099" height="519" />
...
<img loading="lazy" src='/assets/images/local-testing-windows/local-windows-9.webp' alt="Localhost Testing on Android" width="1347" height="623" />
...
<img loading="lazy" src='/assets/images/local-testing-windows/local-windows-10.webp' alt="Launching VM for localhost testing" width="585" height="604" />
...
<img loading="lazy" src='/assets/images/local-testing-windows/local-windows-11.webp' alt="Local testing on iOS" width="1347" height="617" />
...
<img loading="lazy" src='/assets/images/local-testing-windows/local-windows-12.webp' alt="Configuration for localhost testing on iOS" width="1095" height="626" />
...
<img loading="lazy" src='/assets/images/local-testing-windows/local-windows-13.webp' alt="Testing Local folder on <BrandName />" width="1342" height="608" />

**Step 2:**  Click on **‘Folder’**  button and copy the string on your system’s clipboard.

<img loading="lazy" src='/assets/images/local-testing-windows/local-windows-14.webp' alt="access key to test locally hosted website" width="1343" height="559" />
...
<img loading="lazy" src='/assets/images/local-testing-windows/local-windows-15.webp' alt="start local website testing" width="1365" height="595" />
...
<img loading="lazy" src='/assets/images/local-testing-windows/folder.webp' alt="Access local folder for testing" width="1123" height="608" />
...
<img loading="lazy" src='/assets/images/local-testing-windows/tunnel_stopped.webp' alt="Stopping tunnel" width="977" height="292" />

**Option 2:**  You can also disconnect it using the option provided in the user interface. In the top right corner of <BrandName /> interface, you will find a tunnel icon. Click on this icon and then click **x**  to terminate the <BrandName /> tunnel.

<img loading="lazy" src='/assets/images/local-testing-windows/close tunnel.webp' alt="disconnecting <BrandName /> tunnel" width="1349" height="622" /> 

## Geolocation Testing through VPN with <BrandName /> tunnel
***
Test the performance of your web-app through different [geographic locations](https://www.lambdatest.com/blog/geolocation-testing-through-vpn-on-testmu ai/) using VPN in <BrandName /> tunnel. Make sure your website delivers well to your targeted audience from all around the globe.
...
| --- | --- | --- |
|`--key`|123asd123|Helps <BrandName /> to map a tunnel connection with the right user.|
...
<img loading="lazy" src='/assets/images/local-testing-windows/creds.webp' alt="Finding access key" width="1344" height="617" /> 
...
<img loading="lazy" src='/assets/images/local-testing-windows/local-windows-20.webp' alt="REaltime Test for locally hosted webpages" width="1344" height="617" />
...
<img loading="lazy" src='/assets/images/local-testing-windows/local-windows-21.webp' alt="Access key in profile" width="1348" height="618" />
