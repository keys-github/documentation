...
"og:description": "Now integrate your Azure Pipelines with TestMu AI extension plugin to automate your test scripts. Perform live interactive and automated cross-browser testing on 3000+ real browsers and operating systems online using TestMu AI."
---
...
**Step 2:** Create a project and download the <BrandName /> extension from the [Azure marketplace](https://marketplace.visualstudio.com/search?term=lambdatest&target=AzureDevOps&category=All%20categories&sortBy=Relevance) as shown above. <img loading="lazy" src='/assets/images/uploads/m4.webp' alt="azure pipeline" />
...
<img loading="lazy" src='/assets/images/uploads/search-lambdatest.webp' alt="azure pipeline" width="768" height="345" />
