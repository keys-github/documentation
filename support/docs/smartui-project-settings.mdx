...
"og:description": "In this documentation, learn about the project settings available for SmartUI Projects in order to customize your project, manage approvals, configure comparison parameters, and more."
---
...
1. You need an active account with [<BrandName />](https://accounts.lambdatest.com).
...
<img loading="lazy" src='/assets/images/smart-visual-testing/Basic_ss.png' alt="cmd" width="768" height="373" />
...
<img loading="lazy" src='/assets/images/smart-visual-testing/comparison.png' alt="Comparison Settings" width="768" height="373" />
...
<img loading="lazy" src='/assets/images/smart-visual-testing/smart_baseline_ss.png' alt="cmd" width="768" height="373" />
...
<img loading="lazy" src='/assets/images/smart-visual-testing/smart_baseline.png' alt="cmd" width="768" height="373" />
...
<img loading="lazy" src='/assets/images/smart-visual-testing/overwrite_ss.png' alt="cmd" width="768" height="373" />
...
<img loading="lazy" src='/assets/images/smart-visual-testing/notif_ss.png' alt="Notifications Settings" width="768" height="373" />
...
<img loading="lazy" src='/assets/images/smart-visual-testing/delete.png' alt="cmd" width="768" height="373" />
