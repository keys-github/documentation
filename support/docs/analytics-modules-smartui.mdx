...
sidebarTitle: "SmartUI"
keywords: ['analytics', 'visual regression testing', 'smartui analytics', 'screenshot trends', 'build status ratio']
"og:description": "Discover TestMu AI's SmartUI Analytics widgets for comprehensive visual regression testing insights. Optimize your visual testing efforts today."
---
...
{/* <img loading="lazy" src='/assets/images/analytics/smartui-snapshot.png' alt="SmartUI Snapshot" width="768" height="373" /> */}
...
{/* <!-- <img loading="lazy" src='/assets/images/analytics/builds-summary.png' alt="Builds Summary" width="768" height="373" /> */} 
...
{/* <!-- <img loading="lazy" src='/assets/images/analytics/builds-trends.png' alt="Builds Trends" width="768" height="373" /> */} 
...
{/* <!-- <img loading="lazy" src='/assets/images/analytics/screenshot-trends.png' alt="Screenshot Trends" width="768" height="373" /> */} 
...
{/* <!-- <img loading="lazy" src='/assets/images/analytics/screenshots-browsers-device-coverage.png' alt="Screenshots Browsers/Device Coverage" width="768" height="373" /> */} 
...
{/* <!-- <img loading="lazy" src='/assets/images/analytics/screenshots-viewport-coverage.png' alt="Screenshots Viewport Coverage" width="768" height="373" /> */}
...
{/* <!-- <img loading="lazy" src='/assets/images/analytics/build-status-ratio.png' alt="Build Status Ratio" width="768" height="373" /> */}
