---
title: "About Regex Mode"
sidebarTitle: "Filter using Regex"
...
keywords: ['analytics', 'insights', 'test intelligence', 'test analytics']
"og:description": "Filter all the data with Regex patterns to get insights on your test runs. Learn how to use Regex in the analytics widget."
---
...
<img loading="lazy" src='/assets/images/analytics/analytics-regex-view.webp' alt="cmd" width="768" height="373" />
...
<img loading="lazy" src='/assets/images/analytics/analytics-regex-main.webp' alt="cmd" width="768" height="373" />
...
<img loading="lazy" src='/assets/images/analytics/analytics-regex-preview.webp' alt="cmd" width="768" height="373" />
