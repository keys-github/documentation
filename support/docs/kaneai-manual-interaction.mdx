...
"og:description": "Learn how to KaneAI simplifies test automation by allowing manual interaction to create prompts in natural language, analyzing test steps, generating code in various languages."
---
...
<img loading="lazy" src='/assets/images/kane-ai/features/manual-interaction/kaneai-and-start-a-new-test-in-authoring-mode.webp' alt="Image" className="doc_img img_center" />
...
<img loading="lazy" src='/assets/images/kane-ai/features/manual-interaction/kaneai-records-each-action-automatically-as-test-steps.webp' alt="Image" className="doc_img img_center" />
...
<img loading="lazy" src='/assets/images/kane-ai/features/manual-interaction/assertions-using-natural-language.webp' alt="Image" className="doc_img img_center" />
...
<img loading="lazy" src='/assets/images/kane-ai/features/manual-interaction/scroll-infinite-kane-ai.webp' alt="Image" className="doc_img img_center" />
...
<img loading="lazy" src='/assets/images/kane-ai/features/manual-interaction/assertions-to-verify-the-correct-item-or-state-using-natural-language.webp' alt="Image" className="doc_img img_center" />
...
<img loading="lazy" src='/assets/images/kane-ai/features/manual-interaction/start-writing-your-test-using-natural-language-instructions.webp' alt="Image" className="doc_img img_center" />
...
<img loading="lazy" src='/assets/images/kane-ai/features/manual-interaction/disable-manual-interaction.webp' alt="Image" className="doc_img img_center" />

5. Continue the test with natural language instructions.

<img loading="lazy" src='/assets/images/kane-ai/features/manual-interaction/natural-language-instructions.webp' alt="Image" className="doc_img img_center" />
...
<img loading="lazy" src='/assets/images/kane-ai/features/manual-interaction/element-and-drag-it-to-the-required-position.webp' alt="Image" className="doc_img img_center" />
...
<img loading="lazy" src='/assets/images/kane-ai/features/manual-interaction/assertion-in-natural-language-to-verify-the-final-state.webp' alt="Image" className="doc_img img_center" />
...
<img loading="lazy" src='/assets/images/kane-ai/features/manual-interaction/release-the-slider-once-the-desired-value-is-set.webp' alt="Image" className="doc_img img_center" />
...
<img loading="lazy" src='/assets/images/kane-ai/features/manual-interaction/assertion-in-natural-language-to-verify-the-final-value.webp' alt="Image" className="doc_img img_center" />
