...
sidebarTitle: "VNet Peering and VNet Links"
keywords: ['TestMu AI Hyperexecute', 'TestMu AI Hyperexecute help', 'TestMu AI Hyperexecute documentation']
"og:description": "Secure your HyperExecute Private setup with VNet Peering & Links! Our guide helps provision resources, deploy ARM templates, and connect VNets for optimal testing."
---
...
<img loading="lazy" src='/assets/images/hyperexecute/cloud/azure/vnet-peering/1.png' alt="Image" />

***

- You will be able to see **Custom Deployment** page.

<img loading="lazy" src='/assets/images/hyperexecute/cloud/azure/vnet-peering/2.png' alt="Image" />

***

- Click on **Build your own template in the editor** to go to the **Edit template** section.

<img loading="lazy" src='/assets/images/hyperexecute/cloud/azure/vnet-peering/3.png' alt="Image" />
...
```
<img loading="lazy" src='/assets/images/hyperexecute/cloud/azure/vnet-peering/4.png' alt="Image" />
...
<img loading="lazy" src='/assets/images/hyperexecute/cloud/azure/vnet-peering/5.png' alt="Image" />

***

<img loading="lazy" src='/assets/images/hyperexecute/cloud/azure/vnet-peering/6.png' alt="Image" />

***

- Click on the **Review + create** button present at the bottom of the page to navigate to the page shown below.

<img loading="lazy" src='/assets/images/hyperexecute/cloud/azure/vnet-peering/7.png' alt="Image" />
