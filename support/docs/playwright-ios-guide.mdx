...
sidebarTitle: "Test on iOS Device"
description: "Here you can learn how to run Playwright tests on the TestMu AI iOS real devices."
keywords: ['playwright testing', 'playwright ios', 'playwright mobile testing', 'playwright testing on testmu ai', 'playwright testing testmu ai', 'playwright real devices']
"og:description": "Here you can learn how to run Playwright tests on the TestMu AI iOS real devices."
---
...
```javascript title="testmu ai-sample.js"
...
(async () => {
  ...
  console.log('Connecting to TestMu AI iOS cloud...');
  ...
  try {
    ...
    console.log('Marked test as PASSED in TestMu AI dashboard');
    ...
    console.log('Marked test as FAILED in TestMu AI dashboard');
...
<img loading="lazy" src='/assets/images/playwright-testing/playwright-ios-real-device.webp' alt="Image" width="1444" height="703" />
