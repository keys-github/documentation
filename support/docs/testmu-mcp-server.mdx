---
title: "Getting Started with TestMu AI MCP Server"
sidebarTitle: "Setting up TestMu AI MCP Server"
...
<img loading="lazy" src='/assets/images/hyperexecute-mcp/installing-cline.webp' alt="automation-dashboard"  width="1920" height="868"/>
...
<img loading="lazy" src='/assets/images/hyperexecute-mcp/vs-code-config.webp' alt="automation-dashboard"  width="1920" height="868"/>
...
<img loading="lazy" src='/assets/images/hyperexecute-mcp/lt-mcp-auth.png' alt="automation-dashboard"  width="1920" height="868"/>
**Step 6:** Provide valid credentials and authorise client to use <BrandName /> MCP server. 
<img loading="lazy" src='/assets/images/hyperexecute-mcp/lt-auth-credentials.png' alt="automation-dashboard"  width="1920" height="868"/>
**Step 7:** Post authorisation, launch your IDE. 
<img loading="lazy" src='/assets/images/hyperexecute-mcp/lt-ide-auth.png' alt="automation-dashboard"  width="1920" height="868"/>
**Step 8:** MCP <BrandName /> should be connected successfully.
<img loading="lazy" src='/assets/images/hyperexecute-mcp/lt-mcp-success.png' alt="automation-dashboard"  width="1920" height="868"/>
...
**Step 3:** Type the following prompt: `Analyze the project and create a TestMu AI YAML file using MCP TestMu AI server.`<br />
**Step 4:** Cline will:
