...
title: "Extent Report"
sidebarTitle: "Extent"
keywords: ['extent testing reports', 'extent testing testmu ai']
"og:description": "Learn how to generate Extent Report on TestMu AI and download the reports from the dashboard"
---
