...
keywords: ['TestMu AI', 'Accessibility', 'Testing', 'Cypress', 'Cypress version 9', 'Automation', 'Accessibility Testing Settings']
"og:description": "Use TestMu AI Accessibility DevTools to detect and report accessibility issues with automation, following WCAG guidelines, in your cypress tests for version 9 and below"
---
...
<img loading="lazy" src='/assets/images/accessibility-testing/cypress/hyp-cyp9.png' alt="automation-dashboard" />
