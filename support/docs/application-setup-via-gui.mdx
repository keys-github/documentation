...
"og:description": "Explore how to perform operations with your applications like uploading, deleting via gui for real and virtual devices."
---
...
<img loading="lazy" src='/assets/images/appium-app/application/real-device-upload.gif' alt="Image" />
...
<img loading="lazy" src='/assets/images/appium-app/application/automation-upload.gif' alt="Image" />
