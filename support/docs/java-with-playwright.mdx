...
"og:description": "Run your Java automation scripts with Playwright on TestMu AI scalable cloud grid of 50+ real desktop browsers and operating systems."
---
    ...
    public static void main(String[] args) {
        try (Playwright playwright = Playwright.create()) {
            ...
            try {
                ...
                locator.click();
                page.fill("#search_form_input_homepage", "TestMu AI");
