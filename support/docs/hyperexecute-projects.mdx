...
"og:description": "Discover the power of HyperExecute Projects for agile test execution. Learn how to set up and run custom projects with ease, maximizing testing efficiency."
---
...
<source src= '/assets/videos/hyperexecute/projects/copy-project.mp4' type="video/mp4" />
</video>
