...
sidebarTitle: "CLI Upload"
keywords: ['PDF CLI Upload', 'SmartUI CLI', 'Visual Regression Testing', 'PDF Testing', 'Command Line']
"og:description": "Learn how to upload PDF files to SmartUI using the command-line interface for visual regression testing."
---
...
<Tab title="CLI Command Not Found">
...
<Tab title="Upload Returns Error">
