...
sidebarTitle: "Legacy Binary For Linux"
keywords: ['local app testing', 'testmu ai local testing', 'testmu ai local tunnel', 'testmu ai tunnel', 'local app testing for Linux']
"og:description": "This TestMu AI documentation will help you perform Localhost testing of your private web app or websites on your Linux machine through TestMu AI tunnel."
---
...
<Note>
Note: From November 2, 2020 onwards, we have deprecated our existing tunnel binary. In order to setup the new version, you can refer to [new tunnel binary for Linux](/support/docs/local-testing-linux/).
</Note>
...
<img loading="lazy" src='/assets/images/local-testing-for-linux/For-linux-1.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-linux/For-linux-2.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-linux/For-linux-3.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-linux/For-linux-4.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-linux/For-linux-5.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-linux/For-linux-6.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-linux/For-linux-7.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-linux/start-local-testing-on-linux-using-ssh-tunnel.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-linux/For-linux-9.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-linux/start-localhost-testing-linux.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-linux/For-linux-11.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-linux/For-linux-12.webp' alt="Image" />
...
|---------|-------|-------------|
| --key | 123asd123 | Helps <BrandName /> to map a secure shell connection with the right user. |
...
<img loading="lazy" src='/assets/images/local-testing-for-linux/For-linux-13.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-linux/For-linux-14.webp' alt="Image" />

You can also find your **Access Key** by going to ‘**Settings**’ in the left navigation menu and routing to ‘Profile’.

<img loading="lazy" src='/assets/images/local-testing-for-linux/For-linux-15.webp' alt="Image" />
