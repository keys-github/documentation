...
keywords: ['service account testmu ai', 'manage service account', 'create service account']
"og:description": "This documentation will help you create and manage service accounts on TestMu AI."
---
...
<img loading="lazy" src='/assets/images/service-accounts/flow.png' alt="Image" width="585" height="674" className="doc_img img_center" />
...
<img loading="lazy" src='/assets/images/service-accounts/members-tab.webp' alt="Image" width="958" height="288"  className="doc_img img_center" /><br />

**Step 4:** Click on **Create**.

<img loading="lazy" src='/assets/images/service-accounts/click-create.webp' alt="Image" width="958" height="300"  className="doc_img img_center" /><br />

**Step 5:** Enter your preferred **Service Account Name** and click **Create**.

<img loading="lazy" src='/assets/images/service-accounts/enter-service-account-name.webp' alt="Image" width="958" height="360"  className="doc_img img_center" /><br />
...
<img loading="lazy" src='/assets/images/service-accounts/service-account-credentials.webp' alt="Image" width="492" height="264"  className="doc_img img_center" /><br />
...
<img loading="lazy" src='/assets/images/service-accounts/credentials-two.webp' alt="Image" width="588" height="335"  className="doc_img img_center" /><br />

Once you have created the service account, it will appear under the **Service Accounts** tab.

<img loading="lazy" src='/assets/images/service-accounts/creation-complete.webp' alt="Image" width="958" height="340"  className="doc_img img_center" /><br />
...
<img loading="lazy" src='/assets/images/service-accounts/account-deletion.webp' alt="Image" width="958" height="340"  className="doc_img img_center" /><br />

2. A pop-up box will show up. Click **Delete**.

<img loading="lazy" src='/assets/images/service-accounts/confirm-delete.webp' alt="Image" width="958" height="340"  className="doc_img img_center" /><br />
