...
keywords: ['custom css', 'visual regression testing', 'css injection', 'smartui cli', 'visual testing', 'test-only css', 'css configuration', 'visual stability']
"og:description": "Learn how to use SmartUI's customCSS feature to inject test-only CSS styles during snapshots without modifying your application code"
---
...
<Tabs>
  <Tab title="Stabilize Dynamic UI">
...
```
  ...
  <Tab title="Normalize Typography/Theme">
...
```
  ...
  <Tab title="Layout Harmonization">
...
```
  ...
  <Tab title="Mask PII/Identifiers">
...
```
  ...
  <Tab title="Visual Stress Testing">
