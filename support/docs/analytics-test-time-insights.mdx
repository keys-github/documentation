---
title: "Time Insights"
sidebarTitle: "Setup Time Insights"
keywords: ['analytics']
"og:description": "Monitor and optimize test environment setup times with TestMu AI's Setup Time Insights module. Analyze trends, compare across platforms, and receive AI-driven optimization recommendations"
---

import { BrandName } from "/snippets/BrandName.mdx";


<img loading="lazy" src='/assets/images/analytics/astt-widgets.webp' alt="cmd" width="800" height="400" />
...
- **Optimization Recommendations**: Recommendations to optimize the setup time for test environments using [AI Copilot](/support/docs/analytics-dashboard-copilot).
...
- **Collaboration**: Share the setup time insights with team members for collaboration and decision-making using [Dashboard Share](/support/docs/analytics-dashboard-features/#expiry-settings-for-dashboard-share-link).
