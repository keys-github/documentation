...
sidebarTitle: "Concurrency Widget"
...
keywords: ['testmu ai concurrency', 'parallel tests', 'concurrency widget', 'test plans', 'license pool']
"og:description": "Learn how your TestMu AI concurrency works and how to understand the concurrency widget that shows your parallel test usage across different plans and test types."
---
...
<img loading="lazy" src='/assets/images/concurrency-widget/1.png' alt="Image" />
...
<img loading="lazy" src='/assets/images/concurrency-widget/2.png' alt="Image" />
...
<img loading="lazy" src='/assets/images/concurrency-widget/3.png' alt="Image" />

Mobile Browser Automation Testing Widget

<img loading="lazy" src='/assets/images/concurrency-widget/4.png' alt="Image" />
...
<img loading="lazy" src='/assets/images/concurrency-widget/5.png' alt="Image" />
...
<img loading="lazy" src='/assets/images/concurrency-widget/6.png' alt="Image" />
...
<img loading="lazy" src='/assets/images/concurrency-widget/7.png' alt="Image" />
...
<img loading="lazy" src='/assets/images/concurrency-widget/8.png' alt="Image" />
