...
sidebarTitle: "Legacy Binary For Windows"
keywords: ['local app testing', 'testmu ai local testing', 'testmu ai local tunnel', 'testmu ai Tunnel', 'local app testing for windows']
"og:description": "TestMu AI Tunnel feature allows you to test your private server URLs or locally hosted web-apps or websites through TestMu AI cloud servers."
---
...
<Note>
: From November 2, 2020 onwards, we have deprecated our existing tunnel binary. In order to setup the new version, you can refer to [new tunnel binary for Windows](/support/docs/local-testing-windows/).
</Note>
...
<img loading="lazy" src='/assets/images/local-testing-for-windows/For-windows-1.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-windows/For-windows-2.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-windows/For-windows-3.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-windows/For-windows-4.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-windows/For-windows-5.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-windows/For-windows-6.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-windows/For-windows-7.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-windows/start-localhost-testing-using-lambda-tunnel.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-windows/For-windows-9.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-windows/access-local-folders-on-testing-environment.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-windows/For-windows-11.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-windows/start-localhost-testing-ios.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-windows/For-windows-13.webp' alt="Image" />

**Step 2:** After choosing your configurations, hit the ‘**Start**’ button to launch the VM. You will be able to access you locally hosted web pages.

<img loading="lazy" src='/assets/images/local-testing-for-windows/start-ios-localhost-testing.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-windows/For-windows-15.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-windows/For-windows-16.webp' alt="Image" />
...
|----------|---------|-------------|
| --key | 123asd123 | Helps <BrandName /> to map a TCP with TLS 1.2 secure connection with the right user. |
...
<img loading="lazy" src='/assets/images/local-testing-for-windows/For-windows-17.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/local-testing-for-windows/For-windows-18.webp' alt="Image" />

You can also find your Access Key by going to ‘**Settings**’ in the left navigation menu and routing to ‘**Profile**’.

<img loading="lazy" src='/assets/images/local-testing-for-windows/lambda-sshtunnel-access-key.webp' alt="Image" />
