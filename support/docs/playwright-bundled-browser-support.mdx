...
sidebarTitle: "Bundled Browser Support List"
keywords: ['testmu ai', 'playwright', 'support', 'browsers', 'bundled browser', 'playwright bundled', 'playwright browsers']
"og:description": "List of all the Playwright Bundled Browser Support"
---
