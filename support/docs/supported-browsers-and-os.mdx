...
"og:description": "Check out the list of supported browsers and operating systems for Cypress testing on the TestMu AI platform."
---
...
<Note>
: <BrandName /> Automation also supports Cypress testing on Electron browser and in WebKit.
</Note>
