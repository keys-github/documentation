...
sidebarTitle: "Layout Testing"
keywords: ['layout comparison', 'visual regression testing', 'ignore layout differences', 'smartui sdk', 'visual testing', 'layout structure', 'element positions', 'layout testing']
"og:description": "Learn how to use SmartUI SDK's layout testing feature to verify only the layout structure of your pages while ignoring content and style changes"
---
...
<img loading="lazy" src='/assets/images/smart-visual-testing/layout/localisation-netflix.webp' alt="cmd" width="768" height="373" />
...
<img loading="lazy" src='/assets/images/smart-visual-testing/layout/smartignore-amazon.webp' alt="cmd" width="768" height="373" />
...
<img loading="lazy" src='/assets/images/smart-visual-testing/layout/layout-amazon.webp' alt="cmd" width="768" height="373" />
...
- [SmartUI SDK Documentation](/support/docs/smartui-sdk-config-options)
- [Visual Regression Testing Guide](/support/docs/smart-visual-testing)
- [Comparison Settings Documentation](/support/docs/test-settings-options)
