...
"og:description": "Effortlessly link Azure DevOps issues with Test Manager using TestMu AI to streamline workflows and enhance project management efficiency."
---
...
<img loading="lazy" src='/assets/images/ado-linking-test-manager/1.png' alt="Azure DevOps Integration Card" width="1366" height="629" />

2. A side drawer will open to initiate Azure DevOps integration. Click on **Install** to proceed.

<img loading="lazy" src='/assets/images/ado-linking-test-manager/2.png' alt="Azure DevOps Install Drawer" width="1366" height="629" />

3. Select your Azure DevOps Organization and click **Install**. Azure DevOps is now integrated with your <BrandName /> account.

<img loading="lazy" src='/assets/images/ado-linking-test-manager/3.png' alt="Azure DevOps Organization Selection" width="1366" height="629" />
...
<img loading="lazy" src='/assets/images/ado-linking-test-manager/5.png' alt="Link Azure DevOps Issue" width="1366" height="629" />
...
<img loading="lazy" src='/assets/images/ado-linking-test-manager/6.png' alt="Link Azure DevOps Issue" width="1366" height="629" />

4. To **unlink an issue**, click on the unlink button located on the right side of the work item.

<img loading="lazy" src='/assets/images/ado-linking-test-manager/7.png' alt="Link Azure DevOps Issue" width="1366" height="629" />
