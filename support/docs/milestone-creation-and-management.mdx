...
keywords: ['milestone creation']
"og:description": "Check the milestones - datasets, test run and"
---
...
<img loading="lazy" src='/assets/images/milestones/1.png' alt="Real " />
...
<img loading="lazy" src='/assets/images/milestones/2.png' alt="Real " />

### Step 3: Finalize the Milestone
- Review all entered details for accuracy.
- Click **Create Milestone** to finalize the creation.
<img loading="lazy" src='/assets/images/milestones/3.png' alt="Real " />
...
<img loading="lazy" src='/assets/images/milestones/4.png' alt="Real " />
...
<img loading="lazy" src='/assets/images/milestones/5.png' alt="Real " />
...
<img loading="lazy" src='/assets/images/milestones/6.png' alt="Real " />

## Video Explanation
<video class="right-side" width="100%" controls id="vid">
<source src= '/assets/images/milestones/output.mp4' type="video/mp4" />
</video>
