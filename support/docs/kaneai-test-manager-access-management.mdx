...
sidebarTitle: "Access Management - KaneAI <> Test Manager"
...
"og:description": "This documentation will help you to understand how to allocate licence to all the users present in your organization"
---
...
<source src= '/assets/images/access-management/access-license-panel.mp4' type="video/mp4" />
</video>
...
<video class="right-side" width="100%" controls id="vid">
<source src= '/assets/images/access-management/allocate-licenses.mp4' type="video/mp4" />
</video>
...
<video class="right-side" width="100%" controls id="vid">
<source src= '/assets/images/access-management/revoke-license.mp4' type="video/mp4" />
</video>
