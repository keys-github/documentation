...
keywords: ['SmartUI comments', 'Smart Comments', 'Visual testing collaboration', 'Screenshot comments', 'Team collaboration', 'Comment threads']
"og:description": "Learn how to collaborate on visual test results using Smart Comments. Add comments directly on screenshots and builds, mention teammates, and manage threaded discussions for better team collaboration."
---
...
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/smart-comments/comment_icon.png' alt="Comment icon on screenshot"  />

**Comment indicators:**
- Comment icon with count in the screenshot header
- Comment count badge showing total comments for that screenshot

<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/smart-comments/commenttag_screenshotheader.png' alt="Comment tag in screenshot header"  />

### 2. Build Level

Comments can be viewed at the build level, showing the total count of comments across all screenshots in the build.

<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/smart-comments/commenttag_build.png' alt="Comment tag at build level"  />
...
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/smart-comments/comment_drawer.png' alt="Comment drawer with all comments"  />
...
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/smart-comments/firstcomment_textbox.png' alt="Comment textbox in screenshot drawer"  />
...
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/smart-comments/firstcomment_posted.png' alt="Comment posted successfully"  />
...
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/smart-comments/optionalcomment_accept.png' alt="Optional comment in Accept modal"  />
...
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/smart-comments/optionalcomment_acceptall.png' alt="Optional comment in Accept All modal"  />

#### Reject Modal

Add comments when rejecting screenshots:

<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/smart-comments/optionalcomment_reject.png' alt="Optional comment in Reject modal"  />
...
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/smart-comments/optionalcomment_customselection.png' alt="Comment box in bulk operations"  />
...
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/smart-comments/autosaveddraft_textbox.png' alt="Auto-saved draft in textbox"  />

If you write a comment in the Accept modal but close it, the draft is saved.

**2. Draft in Reject Modal:**
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/smart-comments/autoasveddraft_reject.png' alt="Auto-saved draft in Reject modal"  />

**3. Draft in Multiselect:**
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/smart-comments/autosaveddraft_multiselect.png' alt="Auto-saved draft in multiselect"  />
...
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/smart-comments/at_mention.png' alt="Using @mention in comments"  />
...
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/smart-comments/firstthreadcomment_textbox_posted.png' alt="Threaded comment reply"  />
...
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/smart-comments/unresolved_state.png' alt="Unresolved comments state"  />
...
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/smart-comments/resolved_state.png' alt="Resolved comments state"  />
...
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/smart-comments/commenttag_screenshotdrawer.png' alt="Comments in screenshot drawer"  />
...
<Tab title="Use Mentions Strategically">
...
<Tab title="Organize with Threads">
...
<Tab title="Resolve When Complete">
...
<Tab title="Add Context in Comments">
...
<Tab title="Use Bulk Operation Comments">
...
<Tab title="Comment Not Appearing">
...
<Tab title="Comment Character Limit">
...
<Tab title="Comments Deleted Unexpectedly">
...
<Tab title="Resolve/Unresolve Not Working">
...
<Tab title="Bulk Approval with Comment">
...
<Tab title="Reject with Explanation">
