...
sidebarTitle: "JUnit XML Reports"
keywords: ['espresso', 'java', 'espresso junit xml reports', 'testmu ai java', 'framework on testmu ai', 'testng', 'app testing', 'real devices']
"og:description": "Espresso Junit Report"
---
