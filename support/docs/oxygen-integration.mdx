...
keywords: ['testmu ai', 'oxygen test automation', 'test automation framework', 'testmu ai and oxygen', 'oxygen ide', 'record and playback', 'cross browser testing']
"og:description": "Run Oxygen test automation scripts on the TestMu AI Selenium Grid, and perform cross browser testing on 3000+ real browser, on-cloud, for a seamless UI."
---
...
<img loading="lazy" src='/assets/images/Oxygen/Oxygen-1.webp' alt="oxygen integration" width="1354" height="498" />
...
<img loading="lazy" src='/assets/images/Oxygen/1-1.webp' alt="oxygen integration" width="1365" height="384" />
...
<img loading="lazy" src='/assets/images/Oxygen/oxygen-2.webp' alt="oxygen integration" width="1363" height="714" />
...
<img loading="lazy" src='/assets/images/Oxygen/oxygen-3.webp' alt="oxygen integration" width="669" height="296" />
...
<img loading="lazy" src='/assets/images/Oxygen/oxygen-4.webp' alt="oxygen integration" width="711" height="540" />
...
<img loading="lazy" src='/assets/images/Oxygen/oxygen-5.webp' alt="oxygen integration" width="1365" height="283" />
