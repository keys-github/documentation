...
"og:description": "Learn how to use advanced capabilities in the KaneAI authoring for mobile app tests"
---
...
<img loading="lazy" src='/assets/images/kane-ai/mobile-app-features/image1.jpg' alt="Image" className="doc_img img_center" />
...
<img loading="lazy" src='/assets/images/kane-ai/mobile-app-features/image2.jpg' alt="Image" className="doc_img img_center" />
