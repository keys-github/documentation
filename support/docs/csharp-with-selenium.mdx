...
"og:description": "You can now run C# Selenium automated test cases on online scalable TestMu AI Selenium grid of 3000+ real desktop browsers and real operating systems."
---
...
<GitHubButton url="https://github.com/LambdaTest/CSharp-Selenium-Sample" />
 ...
 using System;
    ...
    namespace csharp_selenium_lambdatest
    {
        class SingleTest
        {
            ...
            {
                // Update your testmu ai credentials
...
```
<Warning>
**Note:** You can generate capabilities for your test requirements with the help of our inbuilt **[Capabilities Generator](https://www.testmuai.com/capabilities-generator/)**.
</Warning>
