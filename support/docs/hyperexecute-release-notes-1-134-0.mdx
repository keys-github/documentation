...
<img loading="lazy" src='/assets/images/hyperexecute/release-notes/semaphore.png' alt="Image" />
...
<img loading="lazy" src='/assets/images/hyperexecute/release-notes/cyp-hyp-smartui.png' alt="cmd" width="768" height="373" />
