...
sidebarTitle: "Adding Test Metadata"
keywords: ['testmu ai automation', 'selenium automation grid', 'metadata', 'custom data', 'traceability', 'debugging', 'reporting']
"og:description": "The customData capability allows users to associate additional metadata with test runs, enabling better traceability, debugging, and reporting."
---
