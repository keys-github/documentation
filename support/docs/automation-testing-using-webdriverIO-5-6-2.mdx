...
"og:description": "Now you can run your automation scripts using Selenium with WebDriverIO 5.6.2 on TestMu AI online grid of 3000+ real desktop browsers and real operating systems."
---
...
* * *
>All the code samples in this documentation can be found in the [WebDriverIO 5.6.2 <BrandName /> Repository on <img src='/assets/images/GitHub_icon/github-icon.webp' alt="Image" width="25" height="25"  /> GitHub](https://github.com/LambdaTest/webdriverio-selenium). You can either download or clone the repository to quickly run your tests.
