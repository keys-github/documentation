...
"og:description": "Run your C# automation scripts with Playwright on TestMu AI scalable cloud grid of 50+ real desktop browsers and operating systems."
---
...
class PlaywrightTestSingle
{
    public static async Task main(string[] args)
    {
        ...
        try {
          ...
          await page.FillAsync("[aria-label='Enter your search term']", "TestMu AI");
          await page.Keyboard.PressAsync("Enter");
          var title = await page.TitleAsync();

          if (title.Contains("TestMu AI"))
          {
