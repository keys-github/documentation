...
"og:description": "Navigate through our support doc to adeptly build Configuration & Options for Smart UI using TestMu AI!"
---
...
<img loading="lazy" src='/assets/images/smart-visual-testing/build-status-dotlapse.webp' alt="cmd" width="768" height="373" />
