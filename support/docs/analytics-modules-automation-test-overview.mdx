...
sidebarTitle: "Web & App Automation"
keywords: ['analytics', 'test overview', 'test trends', 'test status ratio', 'test browser', 'test OS', 'test device coverage']
"og:description": "A detailed guide to understanding the test health and trends module. Explore widgets for Test Status, Browser, OS Distribution, and more."
---
...
<img loading="lazy" src='/assets/images/analytics/test-overview-1.png' alt="cmd" width="768" height="373" />
...
<img loading="lazy" src='/assets/images/analytics/test-overview-2.png' alt="cmd" width="768" height="373" />
...
<img loading="lazy" src='/assets/images/analytics/test-overview-3.png' alt="cmd" width="768" height="373" />
...
<img loading="lazy" src='/assets/images/analytics/test-overview-4.png' alt="cmd" width="768" height="373" />
...
<img loading="lazy" src='/assets/images/analytics/test-overview-5.png' alt="cmd" width="768" height="373" />
...
<img loading="lazy" src='/assets/images/analytics/test-overview-6.png' alt="cmd" width="768" height="373" />
...
<img loading="lazy" src='/assets/images/analytics/test-overview-7.png' alt="cmd" width="768" height="373" />
...
<img loading="lazy" src='/assets/images/analytics/test-overview-8.png' alt="cmd" width="768" height="373" />
