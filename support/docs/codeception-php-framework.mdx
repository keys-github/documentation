...
description: "Using Codeception selenium framework with TestMu AI, you can execute automated cross browser testing across 3000+ browsers through our on-cloud Selenium Grid."
---
