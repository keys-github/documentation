...
sidebarTitle: "CLI Complete Reference"
keywords: ['smartui cli', 'cli commands', 'cli options', 'advanced options', 'storybook cli', 'command line interface', 'visual regression testing']
"og:description": "Comprehensive reference guide for SmartUI CLI and Storybook CLI commands, options, advanced features, and end-to-end workflows"
---
...
<Tab title="Branch & Build Management">
| Command | Description | Usage |
|---------|------------|-------|
...
<Tab title="exec:ping / exec:pingTest">
**Check Server Status**
...
<Tab title="URL Grouping for Large Test Suites">
