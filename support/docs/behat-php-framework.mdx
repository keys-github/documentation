...
sidebarTitle: "Behat"
keywords: ['behat', 'behat selenium', 'php selenium', 'php automation testing', 'selenium webdriver php', 'selenium php testing tutorial', 'php selenium framework', 'selenium', 'selenium automation testing', 'selenium testing tool', 'selenium testing tutorial']
"og:description": "Now you can run your automation scripts using Selenium with Behat on TestMu AI online grid of 3000+ real desktop browsers and real operating systems."
---
...
Scenario: Can find search results
    ...
    When I search for "TestMu AI"
 
    Then I get title as "TestMu AI - Google Search"
```
