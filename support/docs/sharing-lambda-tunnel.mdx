...
sidebarTitle: "Sharing TestMu AI Tunnel"
...
"og:description": "Share your SSH connection of TestMu AI Tunnel with teammates belonging to your organization and test your locally hosted web applications or web pages faster."
---
...
<img loading="lazy" src='/assets/images/sharing-lambda-tunnel/localhost-testing-with-shared-tunnel.webp' alt="Sharing <BrandName /> Tunnel" width="1119" height="195" />
...
<img loading="lazy" src='/assets/images/sharing-lambda-tunnel/command-line-code-for-local-testing-with-shared-tunnel.webp' alt="Sharing <BrandName /> Tunnel" width="1090" height="264" />
...
<img loading="lazy" src='/assets/images/sharing-lambda-tunnel/shared-tunnel-for-local-testing.webp' alt="Sharing <BrandName /> Tunnel" width="1105" height="704" />
...
<img loading="lazy" src='/assets/images/sharing-lambda-tunnel/configure-shared-tunnel-for-local-testing.webp' alt="Sharing <BrandName /> Tunnel" width="1334" height="415" />
...
<img loading="lazy" src='/assets/images/sharing-lambda-tunnel/start-local-page-testing-with-shared-tunnel.webp' alt="Sharing <BrandName /> Tunnel" width="1342" height="609" />

Kudos! You have successfully created a Shared <BrandName /> Tunnel for your organization. If you still have any questions, feel free to share them with us through our <span className="doc__lt" onClick={() => window.openLTChatWidget()}>**24/7 chat support**</span> or by mailing to us on [support@testmuai.com](mailto:support@testmuai.com). Happy testing! 🙂
