...
"og:description": "Complete guide to running your first FireTV Appium automated test script on TestMu AI Real Device Cloud Platform. Test on 3000+ Real Devices."
---
...
<Tip>
- If you do not have any **.apk** file, you can run your sample tests on <BrandName /> by using our sample 🔗 [FireTV app](https://prod-mobile-artefacts.lambdatest.com/assets/docs/fireos-sample-app.apk).**
