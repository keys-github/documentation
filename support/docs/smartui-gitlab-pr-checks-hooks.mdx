...
sidebarTitle: "GitLab PR Checks (Hooks)"
keywords: ['GitLab PR checks', 'SmartUI Hooks', 'GitLab merge request integration', 'Visual regression testing', 'Selenium Playwright WebdriverIO', 'Appium mobile testing', 'SmartUI webhooks']
"og:description": "Integrate SmartUI visual regression testing with GitLab merge requests using SmartUI Hooks for web and mobile testing with Selenium, Playwright, WebdriverIO, Appium, and more."
---
...
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/ci-cd-integration/gitlab/1.png' alt="GitLab integration setup in <BrandName />"  />
...
<Tab title="Web Testing (Selenium/Playwright)">
...
<Tab title="Mobile Testing (Appium/WebdriverIO)">
...
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/ci-cd-integration/gitlab/2.png' alt="GitLab CI/CD Variables configuration"  />
...
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/ci-cd-integration/gitlab/pipeline_gitlabtab.png' alt="GitLab Pipelines page showing SmartUI test results"  />
...
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/ci-cd-integration/gitlab/Gitlab_pr_check_dashboard.png' alt="GitLab merge request showing SmartUI PR check status"  />
...
<Tab title="Mobile Testing Example">
...
<Tab title="PR Check Not Appearing">
