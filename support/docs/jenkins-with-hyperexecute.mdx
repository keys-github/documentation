...
"og:description": "Streamline automation with Jenkins and HyperExecute by exploring TestMu AI's comprehensive support documentation."
---
...
<GitHubButton url="https://github.com/LambdaTest/hyp-ci-cd-integration-sample/tree/Jenkins" />
</Tip>

1. Log Into your Jenkins account. You will be directed to your Jenkins dashboard. 

  <img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/jenkins/j1.png' alt="Jenkins Plugin" width="966" height="419" />
...
2. Select the project you want to integrate with HyperExecute. Or else, click on **+ New Item** on the left panel to create a new project. 
  ...
  <img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/jenkins/j2.png' alt="Jenkins Plugin" width="966" height="419" />

3. After opening your project, click on **Configure**.

  <img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/jenkins/j3.png' alt="Jenkins Plugin" width="966" height="419" />

4. Click on **Build Steps**. 

  <img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/jenkins/j4.png' alt="Jenkins Plugin" width="966" height="419" />
...
5. Add a new build step and select **Execute Shell** if you are running your tests on MacOS. Alternatively, select **Execute Windows** batch command if you want to run your test on Windows. 
  ...
  <img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/jenkins/j5.png' alt="Jenkins Plugin" width="966" height="419" />
...
6. Copy and paste the following code snippet in the **Command** section of your Build Step. Click on **Save** to add your Build Step. 
  ...
  - **For Windows**:
    ...
    **Note**: Replace the placeholder values in the code with your username and access key for HyperExecute.
    ...
    <img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/jenkins/j6.png' alt="Jenkins Plugin" width="966" height="419" />

7. Build your Jenkins project by clicking on **Build Now** and wait for a few minutes.

  <img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/jenkins/j7.png' alt="Jenkins Plugin" width="966" height="419" />
  ...
  <img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/jenkins/j8.png' alt="Jenkins Plugin" width="966" height="419" />

  The **HyperExecute Dashboard**: 

  <img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/jenkins/j9.png' alt="Jenkins Plugin" width="966" height="419" />

  Click on the job to find out more details about your tests. 

  <img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/jenkins/j10.png' alt="Jenkins Plugin" width="966" height="419" />
