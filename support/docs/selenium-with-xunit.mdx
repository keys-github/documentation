...
sidebarTitle: "xUnit"
keywords: ['selenium xunit', 'selenium with xunit', 'selenium with xunit on testmu ai', 'xunit testmu ai']
"og:description": "Learn how to run your first Selenium test with xUnit on TestMu AI."
---
...
3. Navigate to *[config.json](https://github.com/LambdaTest/CSharp-xUnit-Selenium/blob/master/XUnit-<BrandName />/config.json/)* using VS Code. Replace this code in the *config.json* file in your project.
...
```csharp
{
  ...
  "capabilities": {
    "lt:options": {
      ...
      "sessionName": "testmu ai xunit sample test",
      "visual": "true",
      "plugin": "xunit:sample"
    }
  },
