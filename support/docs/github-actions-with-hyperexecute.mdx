...
<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/github/github_new_workflow.png' alt="Create New Project" className="doc_img" />
...
<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/github/github_action_yaml.png' alt="Create New Pipeline" className="doc_img" />

### 4. Run the Workflow
To run the new pipeline that you just created, click the **Run workflow** button on the workflow page.

<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/github/run_workflow.png' alt="Create New Project" className="doc_img" />

**Below is an example of how a test that is run on the GitHub Actions pipeline gets executed:**

<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/github/githubactions_example.png' alt="Create New Project" className="doc_img" />

**Below is an example of a HyperExecute job that was triggered through the above pipeline:**

<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/github/githubactions_execution.png' alt="Create New Project" className="doc_img" />
