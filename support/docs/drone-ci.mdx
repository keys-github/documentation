...
sidebarTitle: "Drone CI"
keywords: ['lamdatest', 'drone ci', 'drone testmu ai', 'selenium grid', 'drone ci gitlab integration', 'drone ci cd', 'drone ci demo', 'drone ci environment variables', 'drone ci documentation', 'drone ci example', 'drone ci github', 'drone ci pipeline', 'drone ci secrets', 'drone ci setup', 'drone ci trigger']
"og:description": "This document will help you understand how you can integrate your Drone CI pipeline with cloud Selenium Grid for continuous testing."
---
...
<img loading="lazy" src='/assets/images/drone-ci/profile.webp' alt="Drone CI Integration" width="462" height="325" />
...
<img loading="lazy" src='/assets/images/drone-ci/URL.webp' alt="Drone CI Integration" width="645" height="75" />

**Step 2:** Authorize your GitHub account to access drone.

<img loading="lazy" src='/assets/images/drone-ci/Github.webp' alt="Drone CI Integration" width="526" height="805" />

**Step 3:** Click on the Sync button to sync all the repositories.

<img loading="lazy" src='/assets/images/drone-ci/sync.webp' alt="Drone CI Integration" width="1024" height="104" />

**Step 4:** You will see the repository which you want to use after the sync is completed.

<img loading="lazy" src='/assets/images/drone-ci/synced.webp' alt="Drone CI Integration" width="1012" height="205" />

**Step 5:** You need to activate the repository for which you want to integrate Drone CI, by clicking on the Activate button.

<img loading="lazy" src='/assets/images/drone-ci/activate.webp' alt="Drone CI Integration" width="1012" height="205" />
...
<img loading="lazy" src='/assets/images/drone-ci/activate-repo.webp' alt="Drone CI Integration" width="1012" height="420" />
...
<img loading="lazy" src='/assets/images/drone-ci/repositery.webp' alt="Drone CI Integration" width="1023" height="351" />
...
<img loading="lazy" src='/assets/images/drone-ci/setting.webp' alt="Drone CI Integration" width="1012" height="484" />
...
<img loading="lazy" src='/assets/images/drone-ci/secret.webp' alt="Drone CI Integration" width="959" height="450" />
...
<img loading="lazy" src='/assets/images/drone-ci/edit-drone-yml.webp' alt="Drone CI Integration" width="627" height="231" />
...
<img loading="lazy" src='/assets/images/drone-ci/commit.webp' alt="Drone CI Integration" width="1137" height="308" />

<img loading="lazy" src='/assets/images/drone-ci/select-repo.webp' alt="Drone CI Integration" width="1055" height="225" />
...
<img loading="lazy" src='/assets/images/drone-ci/pipeline-started.webp' alt="Drone CI Integration" width="627" height="181" />
...
<img loading="lazy" src='/assets/images/drone-ci/steps.webp' alt="Drone CI Integration" width="963" height="347" />
...
<img loading="lazy" src='/assets/images/drone-ci/activity-tab.webp' alt="Drone CI Integration" width="627" height="141" />
...
<img loading="lazy" src='/assets/images/drone-ci/failed-test.webp' alt="Drone CI Integration" width="1025" height="467" />
...
<img loading="lazy" src='/assets/images/drone-ci/passed-tests.webp' alt="Drone CI Integration" width="627" height="291" />
...
<img loading="lazy" src='/assets/images/drone-ci/Parallel-Drone-CI.webp' alt="Drone CI Integration" width="627" height="241" />
