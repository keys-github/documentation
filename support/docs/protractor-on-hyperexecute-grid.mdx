...
sidebarTitle: "Protractor"
keywords: ['Protractor', 'Protractor selenium', 'Protractor JavaScript Selenium', 'Protractor automation testing', 'selenium webdriver Protractor', 'selenium Protractor testing tutorial', 'Protractor JavaScript Selenium framework', 'testmu ai Protractor', 'frameworks on testmu ai', 'hyperexecute', 'hyperexecute Protractor testing', 'hyperexecute Protractor testing', 'hyperexecute automation testing', 'HyperExecute Selenium automation']
"og:description": "Learn how to run Selenium automation tests on HyperExecute using the Protractor framework"
---
...
<GitHubButton url="https://github.com/LambdaTest/Protractor-HyperExecute-Sample.git" />
...
```bash
capabilities = {
  build: 'protractor-TestMu AI-Single',
  browserName: 'chrome',
  version:'latest',
  platform: 'Windows 10',
},
