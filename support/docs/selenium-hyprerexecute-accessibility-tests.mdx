...
<a href="https://github.com/LambdaTest/testng-selenium-hyperexecute-sample" target="_blank" className="github__anchor"><img loading="lazy" src='/assets/images/icons/github.png' alt="Image" /> View on GitHub</a>
</Tip>
