...
keywords: ['TestMu AI', 'Accessibility', 'Testing', 'selenium', 'Automation', 'Accessibility Testing Settings']
"og:description": "Use TestMu AI Accessibility DevTools to detect and report accessibility issues with automation, following WCAG guidelines, in your selenium tests"
---
...
<img loading="lazy" src='/assets/images/accessibility-testing/hyp-selenium.gif' alt="automation-dashboard" />
