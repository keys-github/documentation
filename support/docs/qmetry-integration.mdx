...
keywords: ['TestMu AI integrations', 'QMetry', 'Test Automation for GUI Testing', 'test automation', 'QMetry integration with TestMu AI', 'testmu ai integration with QMetry']
"og:description": "With this integration, run your tests from QMetry app, directly on TestMu AI's cloud-based Selenium Grid, on 3000+ desktop & mobile browser and OS combinations"
---
...
<img loading="lazy" src='/assets/images/uploads/QMetry.webp' alt="Activating <BrandName /> Account QMetry app" width="2882" height="1801" />

2.  In the window that opens, navigate to **<BrandName />** tab. Here, you will need to enter your account details and the [desired capabilities](/support/docs/selenium-automation-capabilities/) to execute the test over your <BrandName /> account. 

<img loading="lazy" src='/assets/images/uploads/QMetry-1.webp' alt="Manage Capabilities" width="2882" height="1801" />
...
<img loading="lazy" src='/assets/images/uploads/QMetry-2.webp' alt="<BrandName /> Configuration in Qmetry App" width="2882" height="1801" />
...
<img loading="lazy" src='/assets/images/uploads/QMetry-4.webp' alt="Finding Username and Access Key" width="2882" height="1801" />
...
<img loading="lazy" src='/assets/images/uploads/QMetry-3.webp' alt="Qmetry web capailities list" width="2882" height="1801" />
...
<img loading="lazy" src='/assets/images/uploads/QMetry-4.webp' alt="Saving <BrandName /> Configuration in Qmetry App" width="2881" height="1801" />
...
<img loading="lazy" src='/assets/images/uploads/QMetry-5.webp' alt="<BrandName /> Sample App" width="2881" height="1801" /> 

<img loading="lazy" src='/assets/images/uploads/QMetry-5b.webp' alt="qmetry Sample to do list" width="2881" height="1801" />
...
<img loading="lazy" src='/assets/images/uploads/QMetry-3.webp' alt="Desired Capabilities" width="2881" height="1801" />

Now just select the profile, and hit **Start**. 

<img loading="lazy" src='/assets/images/uploads/QMetry-6.webp' alt="Start Automated Testing Using Qmetry and <BrandName />" width="2881" height="1801" />

The test execution will then start, and you can see the same on the automation dashboard of your <BrandName /> account. 

<img loading="lazy" src='/assets/images/uploads/QMetry-7.webp' alt="Test Automation Dashboard" width="2881" height="1801" />
...
<img loading="lazy" src='/assets/images/uploads/QMetry-8.webp' alt="Test Automation Logs" width="2881" height="1801" />

For each test executed overthe <BrandName /> platform, you can view logs, [mark bugs](/support/docs/mark-as-bug-in-automation-testing/), and do much more.
