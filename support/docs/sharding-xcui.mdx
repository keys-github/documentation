...
keywords: ['sharding', 'XCUIT', 'appium', 'real devices', 'testmu ai cloud platform', 'app automation', 'real time testing', 'appium automation']
"og:description": "This document will cover how to execute XCUI Tests on real devices with HyperExecute. Before starting, please make sure you have App Automation and HyperExecute Cloud plans on your account."
---
...
<img loading="lazy" src='/assets/images/app-automation/sharding-appauto.webp' alt="cmd" width="768" height="373" />
- [TestMu AI HyperExecute](https://hyperexecute.lambdatest.com/hyperexecute)
<img loading="lazy" src='/assets/images/app-automation/sharding-he.webp' alt="cmd" width="768" height="373" />
