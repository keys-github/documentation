...
sidebarTitle: "Multiselect & Bulk Operations"
keywords: ['SmartUI Multiselect', 'Bulk Operations', 'Visual Testing Workflow', 'Batch Approval', 'TestMu AI SmartUI']
"og:description": "Streamline your visual testing workflow with SmartUI Multiselect & Bulk Operations. Approve or reject multiple screenshots simultaneously."
---
...
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/multiselect/dashboard.png' alt="SmartUI multiselect toolbar on Builds dashboard"  />

### Selection states

| State | Description | Screenshot |
| --- | --- | --- |
| None selected | Bulk action buttons stay disabled until at least one screenshot is selected. | <img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/multiselect/noselectionbulkops.png' alt="No selection state"  /> |
| Single selection | Shows contextual details (name, viewport, status). Bulk buttons activate. | <img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/multiselect/noneselected.png' alt="Single screenshot selected"  /> |
| Multi selection | Displays count (e.g., “3 selected”) and unlocks all bulk actions. | <img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/multiselect/selectedstate.png' alt="Multiple screenshots selected"  /> |
...
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/multiselect/approvebulkops.png' alt="Approve bulk operation"  />
...
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/multiselect/rejectbulkops.png' alt="Reject bulk operation"  />
...
<img loading="lazy" width="1300" height="776" src='/assets/images/smart-visual-testing/multiselect/movebulkops.png' alt="Move to baseline bulk operation"  />
...
<Tabs className='docs__val' groupId='workflow'>
  <Tab title="Approve Valid Changes">
...
<Tabs className='docs__val' groupId='best-practices'>
  <Tab title="Verify Filter Context">
...
<li>Check <a href='/support/docs/smartui-troubleshooting-guide/#ci-cd-integration'>SmartUI Troubleshooting Guide</a> for API rate limits or backend incidents.</li>
  ...
  <Tab title="Baseline Promotion Issues">
