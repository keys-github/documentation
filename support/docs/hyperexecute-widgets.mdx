...
<Columns cols={2}>
  <Card title="Job Widgets" href="/support/docs/hyperexecute-job-widgets/">
    Learn the insights of your triggered Jobs on HyperExecute Platform.
  </Card>
  <Card title="Stage Widgets" href="/support/docs/hyperexecute-stage-widgets/">
    Learn the insights of the Stages of your Jobs on HyperExecute Platform.
  </Card>
  <Card title="Task Widgets" href="/support/docs/hyperexecute-task-widgets/">
    Learn the insights of the Tasks on HyperExecute Platform.
  </Card>
  <Card title="Test Widgets" href="/support/docs/hyperexecute-test-widgets/">
    Learn the insights of your Tasks based on the defined parameters in the Tests.
  </Card>
  <Card title="Resource Utilization Widgets" href="/support/docs/hyperexecute-resource-widgets/">
