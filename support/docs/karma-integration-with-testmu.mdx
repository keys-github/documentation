...
sidebarTitle: "Karma Test Runner"
...
keywords: ['karma selenium', 'karma integration with testmu ai', 'testmu ai integrations', 'testacular', 'testmu ai app marketplace']
"og:description": "TestMu AI now integrates with Karma to boost your go-to market delivery. Karma is highly favored in the web developer community due to its outstanding plugin support and integrations with numerous renowned CI packages."
---
...
## Prerequisites
* * *
>All the code samples in this documentation can be found in the [Karma <BrandName /> Repository on <img src='/assets/images/GitHub_icon/github-icon.webp' alt="Image" width="25" height="25"  /> GitHub](https://github.com/LambdaTest/angular-karma-sample). You can either download or clone the repository to quickly run your tests.
...
module.exports = function(config) {
    // TestMu AI grid hostname and port
...
If you wish to use Jenkins, then [follow this documentation](/support/docs/jenkins-with-lambdatest/).
...
<Warning>
: psuedoActivityInterval is presented as a default parameter with a value set to 0. Make sure to provide a value more than 0 in order to avoid the timeouts.
</Warning>
