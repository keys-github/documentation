...
sidebarTitle: Playwright Auto Healing
...
keywords: ['auto heal testmu ai', 'auto heal test flakiness restrictions', 'auto healing testmu ai']
"og:description": "Learn how to use TestMu AI Auto Healing feature in your Playwright tests to avoid test flakiness and increase reliability of your test suites."
---
...
<img loading="lazy" src='/assets/images/selenium/auto-heal.png' alt="add" width="1346" height="647" />
...
test.describe('Browse <BrandName /> in different search engines', () => {
