...
keywords: ['analytics', 'build comparison', 'build compare', 'regression detection', 'test stability', 'build diff', 'test observability']
"og:description": "Compare two builds side by side to identify new failures, fixed tests, and stability changes across your test suite"
---
...
<img loading="lazy" src='/assets/images/analytics/build-comparison-empty-state.webp' alt="Build Comparison - Empty State" />

Click **Select build to compare** to open the build selection dialog.

### Build Selection Dialog

<img loading="lazy" src='/assets/images/analytics/build-comparison-select-build.webp' alt="Build Comparison - Select Build Dialog" />
...
<img loading="lazy" src='/assets/images/analytics/build-comparison-summary.webp' alt="Build Comparison - Key Metrics Summary" />
...
<img loading="lazy" src='/assets/images/analytics/build-comparison-charts.webp' alt="Build Comparison - Results Comparison and Status Changes Charts" />
...
<img loading="lazy" src='/assets/images/analytics/build-comparison-table.webp' alt="Build Comparison - Test Instances Comparison Table" />
