...
"og:description": "Now you can run your automation scripts using Appium with CSharp on TestMu AI online grid of 3000+ real desktop browsers and real operating systems."
---
...
All the code samples in this documentation can be found on **<BrandName />'s Github Repository**. You can either download or clone the repository to quickly run your tests. <GitHubButton url="https://github.com/LambdaTest/LT-appium-csharp" />
</Tip>
...

{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Set your TestMu AI access credentials
            //highlight-next-line
            ...
            // Set other TestMu AI capabilities
            ...
            // Initialize the remote Webdriver using TestMu AI remote URL
