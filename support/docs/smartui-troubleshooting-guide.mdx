...
keywords: ['troubleshooting', 'smartui issues', 'visual testing problems', 'error resolution', 'debugging smartui', 'common errors']
...
<Tab title="Authentication & Setup">
...
1. **Check Latest Versions**:
   ...
   **npm packages**:
   ...
   ```
   **Maven (Java)**:
   - Check [Maven Central](https://mvnrepository.com/artifact/io.github.testmu ai/lambdatest-java-sdk)
