...
sidebarTitle: "Build Merging"
keywords: ['Build Merging', 'SmartUI Git', 'Visual Regression Testing', 'Git Integration', 'Build Management', 'Build Promotion']
"og:description": "Learn how to effectively merge builds in SmartUI for granular control over your visual regression testing workflow."
---
