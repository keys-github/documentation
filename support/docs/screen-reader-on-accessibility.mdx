...
keywords: ['screen reader', 'framework on testmu ai', 'accessibility']
"og:description": "Test your app's accessibility with TestMu AI's Screen Reader as per the WCAG standards."
---
...
<source src= '/assets/images/accessibility-testing/screen-reader/output.mp4' type="video/mp4" />
</video>
