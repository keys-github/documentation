...
"og:description": "Master Selenium Visual Regression testing with TestMu AI. Detect visual deviations early in your web applications to ensure a seamless user experience."
---
...
- Go to [<BrandName /> SmartUI](https://smartui.lambdatest.com/) and login along with your credentials.
...
// Connecting to the <BrandName /> Selenium Cloud Grid with SmartUI
let gridUrl =
  "https://" +
  "<Your Username>" +
  ":" +
...
{/* <img loading="lazy" src='/assets/images/uploads/smart-ui-2.webp' alt="cmd" width="768" height="373" /> */}
...
<Warning>
**The following feature is applicable for `Selenium >= 4.0.0 with Chrome` versions only. Please ensure that the `<BrandName /> Capabilities` are updated in your project for executing full page screenshot(s). **
...
<Tab title="Capability Configuration">
...
<Tab title="Screenshots Show Blank Pages">
...
<Tab title="Build Name Conflicts">
...
<Tab title="Webhook Not Receiving Results">
...
<Tab title="Mismatch Percentage Unexpected">
