...
keywords: ['testmu ai integrations', 'vividus', 'test automation for gui testing', 'test automation', 'vividus integration with testmu ai', 'testmu ai integration with vividus']
...
```javascript
implementation(group: 'org.vividus', name: 'vividus-plugin-testmu ai', version: vividusVersion)
```
...
<img loading="lazy" src='/assets/images/vividus-integration/lt-credentials.webp' alt="Finding Username and Access Key to Perform Automation Testing" width="1281" height="721" />
...
```javascript
- Opening <a href="https://lambdatest.github.io/sample-todo-app/" rel="noopener" target="_blank">TestMu AI ToDo App</a>
...
```javascript
configuration.profiles=testmu ai/web,web/desktop/<browser name>
```

For example, let’s change the browser to Safari:

```javascript
configuration.profiles=testmu ai/web,web/desktop/safari

// Previously it was configuration.profiles=testmu ai/web,web/desktop/chrome
```
...
<img loading="lazy" src='/assets/images/vividus-integration/vividus.webp' alt="Run Tests Using <BrandName /> Vividus Integration" width="1242" height="473" />

* The test execution will then start, and you can see the same on the automation dashboard of your <BrandName /> account.

<img loading="lazy" src='/assets/images/vividus-integration/vividus-1.webp' alt="<BrandName /> automation dashboard" width="1281" height="721" />
...
<img loading="lazy" src='/assets/images/vividus-integration/vividus-2.webp' alt="Test Automation Logs" width="1281" height="721" />
...
<img loading="lazy" src='/assets/images/vividus-integration/vividus-parallel.webp' alt="Test Suite Properties" width="1676" height="781" />
