...
keywords: ['appium', 'appium languages', 'appium framework', 'configuration', 'supported platforms', 'automation testing framework', 'test automation frameworks', 'app testing', 'timezone']
"og:description": "This document provides information about configuring timezone for tests on the TestMu AI platform and also provides list of supported timezones."
---
