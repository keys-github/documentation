...
"og:description": "Learn to set up a Tunnel with HyperExecute effortlessly with our straightforward guide, simplifying the configuration process for you!"
---
...
<img loading="lazy" src='/assets/images/hyperexecute/knowledge-base/secrets/12.png' alt="Image"  style={{width: '500px',}} />
...
## You need to enter your website URL in place of TestMu AI URL
```
