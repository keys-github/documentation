...
<img loading="lazy" src='/assets/images/hive-integration/hive-1.webp' alt="add" width="1342" height="643" />
...
<img loading="lazy" src='/assets/images/hive-integration/hive-2.webp' alt="credentials" width="1365" height="649" />
...
<img loading="lazy" src='/assets/images/hive-integration/prof.webp' alt="api informantion" width="1365" height="643" />

**Step 6:** Click **API info** from the left menu.

<img loading="lazy" src='/assets/images/hive-integration/info.webp' alt="api key" width="1365" height="649" />

**Step 7**: Copy your **API Key** and **User ID**.

<img loading="lazy" src='/assets/images/hive-integration/api.webp' alt="api key and ID" width="1364" height="652" />
...
<img loading="lazy" src='/assets/images/hive-integration/hive-6.webp' alt="bug logging" width="1364" height="637" />
...
<img loading="lazy" src='/assets/images/hive-integration/hive-7.webp' alt="installed" width="1353" height="644" />
...
<img loading="lazy" src='/assets/images/hive-integration/jira-1.webp' alt="start" width="1365" height="660" />
...
<img loading="lazy" src='/assets/images/hive-integration/Capture9-3.webp' alt="bug icon" width="1348" height="619" />

**Step 4:** After a screenshot is captured, you can annotate any issue or a task with an in-built image editor. Once you are done highlighting the bug, click on the button that says "Mark as Bug".

<img loading="lazy" src='/assets/images/hive-integration/Capture13.webp' alt="mark as bug" width="1320" height="618" />
...
<img loading="lazy" src='/assets/images/hive-integration/hive-9.webp' alt="fill the fields" width="1364" height="644" />
...
<img loading="lazy" src='/assets/images/hive-integration/Capture15.webp' alt="bug marked" width="347" height="75" />
...
<img loading="lazy" src='/assets/images/hive-integration/hive-10.webp' alt="issue logged" width="1365" height="622" />
...
<img loading="lazy" src='/assets/images/hive-integration/hive-11.webp' alt="screenshot" width="1365" height="633" />
...
<img loading="lazy" src='/assets/images/hive-integration/hive-12.webp' alt="remove" width="1343" height="645" />
