...
"og:description": "This documentation guides you how to configure the desired capability for app, device, group tests, debugging, and mark tests as passed or failed."
---
...
<Note>
: Appium logs are enabled by default.
</Note>
