...
"og:description": "Learn how to create and configure Bar and Line chart widgets to visualize test data trends, comparisons, and patterns over time or across categories."
---

import { BrandName } from "/snippets/BrandName.mdx";


Bar and Line chart widgets in <BrandName /> Insights enable you to visualize test data trends, comparisons, and patterns. Bar charts are ideal for comparing values across categories, while line charts excel at showing trends and changes over time.
