...
"og:description": "Configure date, time, and hour-format on iOS and Android devices during manual and Appium-based automation testing on TestMu AI."
---
...
<img loading="lazy" src='/assets/images/real-device-app-testing/set-date-and-time-pic1.png' />
...
<img loading="lazy" src='/assets/images/real-device-app-testing/set-date-and-time-pic-last.png' />

---

## Date & Time Configuration Options

<img loading="lazy" src='/assets/images/real-device-app-testing/set-date-and-time-pic2.png' />
...
<img loading="lazy" src='/assets/images/real-device-app-testing/set-date-and-time-pic4.png' />
...
<img loading="lazy" src='/assets/images/real-device-app-testing/set-date-and-time-pic3.png' />
...
<img loading="lazy" src='/assets/images/real-device-app-testing/set-date-and-time-pic-5.png' />
