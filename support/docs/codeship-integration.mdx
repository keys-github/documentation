...
keywords: ['testmu ai integrations', 'continuous integration', 'codeship', 'codeship integration', 'testmu ai codeship integration']
"og:description": "TestMu AI offers continuous integration with Codeship to ease your automated cross browser testing process through their Selenium grid consisting more than 3000+ browsers."
---
...
<img loading="lazy" src='/assets/images/codeship-integration/codeship.webp' alt="Sign up on Codeship" width="1365" height="650" />

**Step 2:** Select GitHub as your SCM.

<img loading="lazy" src='/assets/images/codeship-integration/codeship-1.webp' alt="Select GitHub as your SCM" width="1346" height="647" />

**Step 3:** Provide your GitHub organization and your GitHub repository, then hit **Connect.**

<img loading="lazy" src='/assets/images/codeship-integration/codeship-2.webp' alt="Provide your GitHub organization" width="1344" height="649" />

**Step 4:** Now, you need to opt for **"Codeship Basic"** as your project type by clicking on **"Select Basic Project."**

<img loading="lazy" src='/assets/images/codeship-integration/codeship-3.webp' alt="opt for Codeship Basic" width="798" height="415" />
