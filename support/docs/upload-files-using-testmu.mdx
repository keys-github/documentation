...
You can upload the files on the <BrandName /> cloud based Selenium Grid, using our [API for uploading user-files](/support/api-doc/projects/create-project). Follow the steps below to learn how:

*   Open [<BrandName />'s API for uploading user-files](/support/api-doc/projects/create-project/) <img loading="lazy" src='/assets/images/uploads/upload-files.webp' alt="Upload file" width="1281" height="721"/>
...
- Files are already uploaded to <BrandName /> storage using the [file upload API](/support/api-doc/projects/create-project)
