...
keywords: ['TestMu AI', 'Accessibility', 'Testing', 'Bug Reporting', 'Reports']
"og:description": "Report the bugs that you are expereinceing"
---
...
<img loading="lazy" src='/assets/images/accessibility-testing/mark-bug/01.png' alt="accessibility-mark-bug" />
...
<img loading="lazy" src='/assets/images/accessibility-testing/mark-bug/02.png' alt="accessibility-mark-bug" />
