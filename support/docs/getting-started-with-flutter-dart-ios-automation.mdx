...
"og:description": "This guide details running your first Flutter Dart test on real iPhones using TestMu AI's Real Device Cloud."
---
...
<Tip>
**If you do not have any **Flutter iOS** test suite (.zip), you can run your sample tests on <BrandName /> by using our sample 🔗 [Flutter iOS](https://prod-mobile-artefacts.lambdatest.com/assets/docs/Flutter_iOS.zip).**
...
Once you have run your tests, you can view the test execution along with logs. You will be able to see the test cases passing or failing. You can view the same at [TestMu AI Automation](https://appautomation.lambdatest.com/builds).
