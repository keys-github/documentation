...
keywords: ['testmu ai automation', 'testmu ai kaneai', 'kaneai deeplink', 'mobile app testing', 'deeplink navigation', 'android deeplink', 'ios deeplink']
"og:description": "Learn how to use deeplinks in KaneAI to directly navigate to specific screens in your Android and iOS mobile applications during test authoring."
---
...
<img loading="lazy" src='/assets/images/kane-ai/features/add-deeplink-modal.png' alt="Add Deeplink Modal" />
