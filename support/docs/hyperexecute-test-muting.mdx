---
title: "Test Muting"
sidebarTitle: "Test Muting"
description: "Understand how to mute tests on scenario level in HyperExecute."
keywords: ['TestMu AI Hyperexecute', 'TestMu AI Hyperexecute help', 'TestMu AI Hyperexecute documentation', 'Test Muting', 'Mute test cases']
"og:description": "Understand how to mute tests on scenario level in HyperExecute."
---
...
<img loading="lazy" src='/assets/images/hyperexecute/features/test-muting/4.png' alt="Image" />
...
<img loading="lazy" src='/assets/images/hyperexecute/features/test-muting/8.png' alt="Image" />
...
<img loading="lazy" src='/assets/images/hyperexecute/features/test-muting/6.png' alt="Image" style={{width: '700px',}} />
