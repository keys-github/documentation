...
"og:description": "In this documentation, learn how integrate your WebdriverIO automated tests with TestMu AI's SmartUI."
---
...
You can clone the sample repository to run `<BrandName />` automation tests with `SmartUI` and use the `cloud.e2e.js` file present in the `test/specs` folder.
...
Install required NPM modules for `<BrandName /> SmartUI WebdriverIO SDK` in your **Frontend** project.
