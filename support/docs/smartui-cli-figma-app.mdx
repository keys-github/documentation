...
sidebarTitle: "Figma-App CLI"
keywords: ['Visual Regression', 'Mobile App Visual Testing', 'Figma to App Comparison', 'SmartUI CLI', 'TestMu AI Mobile', 'Design to Production Validation']
"og:description": "Learn how to compare your Figma mobile designs with native app screenshots on real devices using SmartUI CLI."
---
