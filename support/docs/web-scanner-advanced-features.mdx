...
keywords: ['testmu ai', 'web scanner', 'advanced features', 'authentication', 'basic auth', 'form selectors', 'dedicated proxy', 'geolocation', 'tunnel', 'local testing']
"og:description": "Learn how to configure advanced features in Web Scanner including authentication (Basic Auth and Form Selectors), dedicated proxy, geolocation, and tunnel for testing locally hosted pages."
---
...
<img loading="lazy" src='/assets/images/web-scanner/visual-scan-advanced-settings.png' alt="Advanced Configurations for Visual Scan" />
...
<img loading="lazy" src='/assets/images/web-scanner/accessibility-scan-advanced-options.png' alt="Login Configurations Modal" />
