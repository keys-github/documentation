...
keywords: ['TestMu AI', 'Accessibility', 'Testing', 'DevTools', 'run quick scan', 'test issues', 'Partial Page Scanner']
"og:description": "Partial Page Scanner scans specific webpage elements, tests components, investigates reported issues and evaluates changes made to a specific area."
---
...
<img loading="lazy" src='/assets/images/accessibility-testing/partial-page-scanner/1.png' alt="automation-dashboard" />
...
- Click on **Start Scan** button.
    ...
    <img loading="lazy" src='/assets/images/accessibility-testing/partial-page-scanner/2.png' alt="automation-dashboard" />

    - It will scan that particular section and will list down the issues with that section (if found any).

    <img loading="lazy" src='/assets/images/accessibility-testing/partial-page-scanner/3.png' alt="automation-dashboard" />
