...
"og:description": "Use TestMu AI Accessibility DevTools to detect and report accessibility issues with automation, following WCAG guidelines, in your cypress tests for version 9 and above"
---
...
<GitHubButton url="https://github.com/LambdaTest/lambdatest-accessibility-cypress-v9" />
</Tip>

Configure the desired capabilities based on your test requirements. For example:

```yaml reference title="lambdatest-config.json"
  https://github.com/LambdaTest/lambdatest-accessibility-cypress-v9/blob/main/lambdatest ai-config.json
```
