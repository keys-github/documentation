...
sidebarTitle: "HyperExecute GUI App"
...
<img src='/assets/images/hyperexecute/gui/guilanding.png'  />
...
<source src= '/assets/videos/hyperexecute/cli-gui/GUI_Demo.mp4' type="video/mp4" />
</video> */}
...
<video class="right-side" width="100%" controls id="vid">
<source src= '/assets/videos/hyperexecute/cli-gui/projectselect_analyze.mp4' type="video/mp4" />
</video>
...
<video class="right-side" width="100%" controls id="vid">
<source src= '/assets/videos/hyperexecute/cli-gui/testselection.mp4' type="video/mp4" />
</video>
...
<video class="right-side" width="100%" controls id="vid">
<source src= '/assets/videos/hyperexecute/cli-gui/job_run.mp4' type="video/mp4" />
</video>
...
<video class="right-side" width="100%" controls id="vid">
<source src= '/assets/videos/hyperexecute/cli-gui/import_config_new.mp4' type="video/mp4" />
</video>
