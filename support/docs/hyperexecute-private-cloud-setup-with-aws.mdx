...
sidebarTitle: "Setup with AWS"
keywords: ['hyperexecute aws', 'hyperexecute private cloud', 'hyperexecute private cloud aws']
"og:description": "This documentation will help you setup HyperExecute Private Cloud with AWS."
---
...
<img loading="lazy" src='/assets/images/hyperexecute/cloud/aws/Step1.png' alt="Image" width="585" height="674" className="doc_img img_center" />
...
<img loading="lazy" src='/assets/images/hyperexecute/cloud/aws/Step3.png' alt="Image" width="585" height="674" className="doc_img img_center" />
...
<img loading="lazy" src='/assets/images/hyperexecute/cloud/aws/Step2.png' alt="Image" width="585" height="674" className="doc_img img_center" />
...
<img loading="lazy" src='/assets/images/hyperexecute/cloud/aws/namespace_output.png' alt="Image" width="585" height="674" className="doc_img img_center" />
...
<img loading="lazy" src='/assets/images/hyperexecute/cloud/aws/list_pods.png' alt="Image" width="585" height="674" className="doc_img img_center" />

**Step 5:** Access the Private Cloud deployment using the provided [link](https://dashboard.hyperexecute.cloud/).

**Step 6:** If the emailID you used to setup this deployment is not an existing user on <BrandName /> then check your Email, there should be a email titled `Create Password - TestMu AI`, generate a new password using the link provided in the email.
