...
sidebarTitle: "ADB Commands Support"
...
keywords: ['appium', 'java', 'testmu ai java', 'framework on testmu ai', 'testng', 'app testing', 'real devices', 'adb commands']
"og:description": "TestMu AI provides support for limited commands which can be executed in your app automation test scripts via javascript executors."
---
...
- **adb shell cat** <RealDeviceTag value="Real Device" />
  ...
  result = driver.execute_script("lambda-adb", params)
  ```
<img loading="lazy" src='/assets/images/appium-app/adb-commands.png' alt="Image" width="1444" height="703"  className="doc_img img_center" />
...
When you disable app notification permissions using the command, the app goes into the background. This behavior occurs due to limitations with ADB, and you need to reactivate the app through test script.
</Note>
...
# Execute commands using TestMu AI's ADB execution method
