---
title: "Table Widgets"
sidebarTitle: "Table Widgets"
keywords: ['analytics', 'dashboards', 'table widgets', 'data visualization', 'custom widgets', 'test insights', 'tabular data', 'data tables']
"og:description": "Learn how to create and configure Table widgets to display structured test data in tabular format with multiple columns, aggregations, and grouping options."
---

import { BrandName } from "/snippets/BrandName.mdx";


Table widgets in <BrandName /> Insights enable you to display structured test data in a tabular format, making it easy to view detailed information, compare values across multiple dimensions, and analyze data with multiple columns and aggregations.
...
<img loading="lazy" src='/assets/images/analytics/custom-widget-table-config.webp' alt="Table Widget Configuration Interface" />

## Prerequisites

Before creating a table widget, ensure you have completed the [common prerequisites and setup steps](/support/docs/dashboards-custom-widgets#prerequisites) for custom widgets.
...
For a complete list of available keys that can be used for configuring table columns, aggregations, and grouping, see the [Available Keys for Custom Widgets](/support/docs/dashboards-custom-widgets#available-keys-for-custom-widgets) section in the main Custom Widgets documentation.
