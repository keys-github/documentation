...
sidebarTitle: "Report Scheduling"
keywords: ['analytics', 'report scheduling', 'widget reports', 'scheduled reports', 'analytics notifications']
"og:description": "Customize the delivery time for your analytics widget reports. Schedule reports at your preferred time for timely business insights."
---
...
- You must have at least one [Insights dashboard](/support/docs/analytics-create-dashboard/) created.
...
- [Create Your Custom Dashboard](/support/docs/analytics-create-dashboard/)
- [Dashboard Settings](/support/docs/analytics-dashboard-settings/)
- [Dashboard Features](/support/docs/analytics-dashboard-features/)
