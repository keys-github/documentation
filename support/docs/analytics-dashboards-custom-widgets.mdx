...
sidebarTitle: "Create Custom Widgets"
keywords: ['analytics', 'dashboards', 'custom widgets', 'data visualization', 'custom dashboards', 'test data']
"og:description": "A powerful tool to visualize your test data and gain insights into your testing process."
---
...
<iframe width="800" height="450" src="https://www.youtube.com/embed/DEY1hhEme6Q?si=hBN9X2hK-QHvgHIA" title="Exploring Custom Widgets for Dashboards in <BrandName /> Insights" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

## Prerequisites

Before creating a custom widget, ensure you have:

1. An active <BrandName /> account with access to Insights
2. Executed tests on the <BrandName /> platform to generate data
...
1. Log in to your [<BrandName /> account](https://accounts.lambdatest.com/login).
...
- **[Heatmap Widgets](/support/docs/analytics-heatmap-widgets)**: Create heatmap visualizations to identify patterns across multiple dimensions
- **[Bar and Line Chart Widgets](/support/docs/analytics-bar-line-widgets)**: Create bar and line charts to visualize trends and comparisons
- **[Table Widgets](/support/docs/analytics-table-widgets)**: Create structured tables with multiple columns and aggregations
...
- **[Heatmap Widgets](/support/docs/analytics-heatmap-widgets)**: Visualize data density and relationships across multiple dimensions using color intensity and box sizes
- **[Bar Chart Widgets](/support/docs/analytics-bar-line-widgets)**: Compare values across categories using rectangular bars
- **[Line Chart Widgets](/support/docs/analytics-bar-line-widgets)**: Track trends and changes over time using connected data points
- **[Table Widgets](/support/docs/analytics-table-widgets)**: Display structured data with multiple columns, aggregations, and grouping options
...
- [Heatmap Widget Use Cases](/support/docs/analytics-heatmap-widgets#use-cases-for-heatmap-widgets)
- [Bar and Line Chart Use Cases](/support/docs/analytics-bar-line-widgets#use-cases-for-bar-and-line-chart-widgets)
- [Table Widget Use Cases](/support/docs/analytics-table-widgets#use-cases-for-table-widgets)
