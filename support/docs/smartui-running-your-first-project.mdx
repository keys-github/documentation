...
<a href="https://github.com/LambdaTest/smartui-java-testng-sample" target="_blank" className='github__anchor'><img loading="lazy" src='/assets/images/icons/github.png' alt="Image" /> View on GitHub</a>
</Tip>
...
<Note>
**You can check the latest version of [testmu ai-java-sdk]( https://mvnrepository.com/artifact/io.github.lambdatest/lambdatest-java-sdk) and update the latest version accordingly.**
