---
title: "Selenium Testing With Codefresh CI And TestMu AI"
...
![Sign up on Codeship](/assets/images/codefresh-integration/go_to_pipelines.png)

**Step 2:** Select your user/git organisation, select repository and then click create.

![Select GitHub as your SCM](/assets/images/codefresh-integration/select_git.png)

**Step 3:** After the creation of pipeline, you must see the workflow YAML got generated, with your selected github repository.

![opt for Codeship Basic](/assets/images/codefresh-integration/workflow.png)
...
![opt for Codeship Basic](/assets/images/codefresh-integration/pipeline_ruuning.png)
...
![opt for Codeship Basic](/assets/images/codefresh-integration/lt_dash.png)
