...
"og:description": "Discover how to leverage TestMu AI's SmartUI upload API v2 for seamless Visual Regression Testing. Learn the prerequisites, create projects."
---
...
<img loading="lazy" src='/assets/images/smart-visual-testing/upload-images-api-3.png' alt="cmd" width="768" height="373" />
<img loading="lazy" src='/assets/images/smart-visual-testing/upload-images-api-2.png' alt="cmd" width="768" height="373" />
