...
"og:description": "Multi-Page Scanner scans across multiple web pages for a comprehensive overview of potential issues and prioritizes fixes impacting the user experience."
---
