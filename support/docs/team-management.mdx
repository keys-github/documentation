...
keywords: ['teams management testmu ai', 'manage teams']
"og:description": "This documentation will help you create and manage teams on TestMu AI."
---
...
<source src= '/assets/videos/team-management/1.mp4' type="video/mp4" />
</video>
...
<video class="right-side" width="100%" controls id="vid">
<source src= '/assets/videos/team-management/2.mp4' type="video/mp4" />
</video>
...
<video class="right-side" width="100%" controls id="vid">
<source src= '/assets/videos/team-management/3.mp4' type="video/mp4" />
</video>
...
<video class="right-side" width="100%" controls id="vid">
<source src= '/assets/videos/team-management/4.mp4' type="video/mp4" />
</video>
