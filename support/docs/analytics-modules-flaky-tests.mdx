...
sidebarTitle: "Flaky Tests Insights"
keywords: ['analytics']
"og:description": "Analyze your flaky tests with Test Intelligence and get insights on the flaky tests that are causing your test runs to fail."
---
...
<img loading="lazy" src='/assets/images/analytics/atx-flakiness-trends.webp' alt="cmd" width="768" height="373" />
...
<img loading="lazy" src='/assets/images/analytics/atx-ftd-severity.webp' alt="cmd" width="768" height="373" />
...
<img loading="lazy" src='/assets/images/analytics/atx-ftd-tests-group-view.webp' alt="cmd" width="768" height="373" />
...
To read more about the Flaky Tests Analytics, you can refer the documentation at [Flaky Tests - Test Intelligence](/support/docs/test-intelligence-flakiness-test-detection/)
</Note>
