...
"og:description": "SmartUI now integrates with Bitbucket Pipeline to boost pipeline delivery. Perform automated cross browser testing with SmartUI to seamlessly providing 3000+ real browsers running through machines."
---
...
<GitHubButton url="https://github.com/amanchopra1905/smartui-ci-cd-integrations/tree/bitbucket" />
</Tip>
