...
sidebarTitle: "Selenide"
keywords: ['Selenide', 'Selenium', 'Selenium automation testing', 'Selenium Testing tool', 'Selenium testing tutorial', 'selenium python', 'Selenium Grid', 'Selenium Automation']
"og:description": "Your guide to running tests using Selenide on TestMu AI's Selenium Grid of 3000+ real devices and desktop browsers."
---
...
All the code samples in this documentation can be found on **<BrandName />'s Github Repository**. You can either download or clone the repository to quickly run your tests. <GitHubButton url="https://github.com/LambdaTest/selenide-testng-sample" />
...
public class LambdaTestSetup {
    ...
    public void test() throws Exception {
        ...
        $(By.name("q")).setValue("TestMu AI").pressEnter();

        sleep(2000);

        Assert.assertEquals(title(), "TestMu AI - Google Search");
