...
sidebarTitle: "Jira"
keywords: ['TestMu AI integrations', 'Push issues to Jira', 'TestMu AI Jira integration']
"og:description": "TestMu AI provides integrations with JIRA to help you log bugs directly from the middle of your test session on TestMu AI to JIRA platform."
---
...
<img loading="lazy" src='/assets/images/jira-integration/0.png' alt="jira" width="371" height="441" />
...
<img loading="lazy" src='/assets/images/jira-integration/1.png' alt="jira" width="1346" height="610" />
...
<img loading="lazy" src='/assets/images/jira-integration/2.png' alt="jira" width="1365" height="624" />

**Step 5:** Click on the Install button to be redirected to the Jira dashboard.

**Step 6:** Click on Accept.

<img loading="lazy" src='/assets/images/jira-integration/3.png' alt="jira" width="1365" height="624" />
...
<img loading="lazy" src='/assets/images/jira-integration/4.png' alt="jira" width="1365" height="624" />
...
<img loading="lazy" src='/assets/images/jira-integration/5.png' alt="jira" width="1365" height="624" />
...
<img loading="lazy" src='/assets/images/jira-integration/6.png' alt="jira" width="1365" height="624" />
...
<img loading="lazy" src='/assets/images/jira-integration/jira-12.webp' alt="jira-integration" width="1352" height="599" />

**Step 2**: Select the captured screenshots that you want to share and click on **Mark As Bug**.

<img loading="lazy" src='/assets/images/jira-integration/jira-15.webp' alt="jira-integration" width="1354" height="598" />
...
<img loading="lazy" src='/assets/images/jira-integration/jira-13.webp' alt="jira-integration" width="1352" height="625" />

**Step 4**: Visit your Jira dashboard. You’ll find your marked issues right away.

<img loading="lazy" src='/assets/images/jira-integration/Screenshot-96.webp' alt="jira-integration" width="1338" height="592" /> */}
...
<img loading="lazy" src='/assets/images/jira-integration/7.png' alt="jira" width="1365" height="624" />
...
<img loading="lazy" src='/assets/images/jira-integration/8.png' alt="jira" width="1365" height="624" />
...
<img loading="lazy" src='/assets/images/jira-integration/9.png' alt="jira" width="1365" height="624" />
...
<img loading="lazy" src='/assets/images/jira-integration/10.png' alt="jira" width="1365" height="624" />
...
<img loading="lazy" src='/assets/images/jira-integration/11.png' alt="jira" width="1365" height="624" />

**Step 7:** Log in to your Jira dashboard. You will be able to notice the logged issue right away! All the data you provided through <BrandName /> would already be presented in it. <BrandName /> automatically includes test environment details and related screenshots in the ticket as attachments.
...
<img loading="lazy" src='/assets/images/jira-integration/12.png' alt="jira" width="1365" height="624" />
