...
keywords: ['Visual Regression', 'SmartUI SDK', 'Basic Authentication', 'Protected Assets', 'Authentication Headers']
"og:description": "Learn how to capture screenshots of assets protected behind authentication using SmartUI CLI"
---
