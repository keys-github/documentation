...
"og:description": "This topic will teach you how you can configure your own YAML through GoCD and then integrate your pipeline with an online Selenium Grid."
---
...
<Warning>
**Note:** If you are just getting started with GoCD then make sure to visit our documentation to [integrate <BrandName /> with GoCD](/support/docs/gocd-integration-with-testmu/).
</Warning>
...
<img loading="lazy" src='/assets/images/yaml-integration/YAML.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/yaml-integration/YAML-1.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/yaml-integration/YAML-2.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/yaml-integration/YAML-3.webp' alt="Image" />

**Step 5:** Under Advanced setting, you need to specify your <BrandName /> authentication credentials as the environment variables.

<img loading="lazy" src='/assets/images/yaml-integration/YAML-4.webp' alt="Image" />
...
<img loading="lazy" src='/assets/images/yaml-integration/YAML-5.webp' alt="Image" />

Now, you just need to execute the job like we did in the previous chapter when we [integrated GoCD with <BrandName />](/support/docs/gocd-integration-with-testmu/). That is all you need to do if you wish to configure a private YAML file before you run your Selenium testing scripts over <BrandName /> Selenium Grid.
