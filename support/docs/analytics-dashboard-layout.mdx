...
sidebarTitle: "Edit Dashboard Layout"
keywords: ['analytics']
"og:description": "Enhance Your Analytics Dashboard Edit Layout with TestMu AI's Widget Management Feature Customizing Layout for Improved Insights"
---
...
To use the new widget management feature in <BrandName /> insights, ensure that you have the following:

- An active <BrandName /> account
- Existing dashboards with widgets

## Step by Step Process to Use the Feature

Follow these steps to utilize the new widget management feature in <BrandName /> insights:
