...
keywords: ['testcafe', 'testcafe integration', 'node.js', 'cross browser testing', 'developer tools', 'npm package']
...
<Warning>
**Important:** Visit <BrandName /> [npm package for TestCafe](https://www.npmjs.com/package/testcafe-browser-provider-testmu ai).
</Warning>
...
``` js
npm install testcafe-browser-provider-testmu ai
```
...
``` js
testcafe -b testmu ai
```

To execute the test from cmd/terminal by declaring the browsers and operating systems to test:

``` js
$ testcafe "testmu ai:Chrome@74.0:Windows 8" 'path/to/test/file.js'
```

For Parallel testing:

``` js
$ testcafe "testmu ai:Chrome@74.0:Windows 8","testmu ai:Chrome@75.0:Windows 10" "path/to/test/file.js"
```
...
testCafe
    ...
    .browsers('testmu ai:Chrome@74.0:Windows 8')
    .run();
```
...
-----------------------------------------------------------------------------------------------------------------------------
<Note>
: TestCafe integration with <BrandName /> does not support Geolocation testing.
</Note>
...
testcafe "testmu ai:Chrome","testmu ai:Chrome@74.0:Windows 8" tests/
```
