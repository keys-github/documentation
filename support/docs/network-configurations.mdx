...
keywords: ['testmu ai automation', 'appium network logs', 'espresso network logs', 'xcuitest network logs', 'mitm proxy', 'http traffic capture', 'domain filtering automation']
"og:description": "Learn how to configure and capture HTTP/S traffic during automation testing on TestMu AI Real Devices."
---
