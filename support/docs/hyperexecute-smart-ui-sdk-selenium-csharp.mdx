...
"og:description": "Automate Hyperexecute tests seamlessly! Integrate SmartUI SDK with CSharp for efficient & reliable UI testing."
---
...
```cs
<ItemGroup>
    <PackageReference Include="TestMu AI.Selenium.Driver" Version="1.0.1" />
</ItemGroup>
```
...
using TestMu AI.Selenium.Driver;

namespace TestMu AI.Selenium.TestProject
{
