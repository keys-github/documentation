...
keywords: ['testmu ai', 'smart ui', 'freeze animations', 'storybook', 'animation svg screenshots']
"og:description": "SmartUI can now capture the screenshots of your animations running in the browser by freezing it."
---
