...
keywords: ['analytics', 'AI RCA', 'root cause analysis', 'test intelligence', 'test failure analysis', 'debugging', 'AI insights']
"og:description": "Automatically analyze test failures with AI-powered Root Cause Analysis. Get instant insights into test failure patterns and accelerate debugging with actionable RCA results."
---
...
<img loading="lazy" src='/assets/images/analytics/test-intelligence-ai-test-rca-output.webp' alt="RCA Output" width="800" height="400" />
...
3. **Available Credits**: Tests will only be processed through RCA when sufficient credits are available. For more information on credit management, see our [Credits Management](/support/docs/credits-management/) documentation.
...
<img loading="lazy" src='/assets/images/analytics/test-intelligence-ai-test-rca-tms.webp' alt="Generate RCA in Test Manager" width="800" height="400" />
...
<img loading="lazy" src='/assets/images/analytics/test-intelligence-ai-test-rca-hyperexecute.webp' alt="Generate RCA in HyperExecute" width="800" height="400" />
...
<img loading="lazy" src='/assets/images/analytics/test-intelligence-ai-test-rca-insights.webp' alt="RCA Insights Dashboard" width="800" height="400" />
...
<img loading="lazy" src='/assets/images/analytics/test-intelligence-ai-test-rca-configuration.webp' alt="Automatic AI RCA Configuration" width="800" height="400" />
...
<img loading="lazy" src='/assets/images/analytics/test-intelligence-ai-test-rca-category.webp' alt="Custom RCA Categories Management" width="800" height="400" />
...
<Accordion title="RCA Not Generating">

- **Check prerequisites**: Ensure you have the required subscription plan
- **Verify credits availability**: AI RCA processing requires credits to be available in your account. Check your [Credits Management](/support/docs/credits-management/) page to ensure sufficient credits
...
<Accordion title="Inaccurate RCA Results">
...
<Accordion title="Missing RCA Data">
...
- [Smart Tags - Test Intelligence](/support/docs/analytics-smart-tags-test-intelligence/)
- [Failure Categorization AI](/support/docs/analytics-test-failure-classification/)
- [Test Insights Overview](/support/docs/analytics-test-insights/)
