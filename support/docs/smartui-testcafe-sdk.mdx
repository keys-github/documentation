...
"og:description": "In this documentation, learn how integrate your Testcafe automated tests with TestMu AI's SmartUI."
---
...
Install required NPM modules for `<BrandName /> SmartUI Testcafe SDK` in your **Frontend** project.
...
test('Take Amazon Homepage Screenshot', async (t) => {
  // Take a screenshot using <BrandName />'s TestCafe driver
