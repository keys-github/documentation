...
"og:description": "Dive into our detailed XCUI Visual Regression support documentation for step-by-step guidance! Efficiently perform visual testing, manage applications, and ensure your mobile apps are visually perfect before launch."
---
...
If you do not have any **iOS** app (.ipa) and an **iOS Test** app (.ipa) file, you can run your sample tests on <BrandName /> by using our sample 🔗 [XCUI app](https://prod-mobile-artefacts.lambdatest.com/assets/docs/prod-ios-app.ipa) and a sample 🔗 [XCUI Test App](https://prod-mobile-artefacts.lambdatest.com/assets/docs/prod-ios-test-app.ipa).

Download or Clone the code sample from the <BrandName /> GitHub repository to run the tests on the SmartUI.
<GitHubButton url="https://github.com/LambdaTest/lambdatest-xcui" />
</Tip>
...
- Update this [dependency](https://swiftpackageindex.com/lambdatest-xcui) in your test classes. You can do it as follows:
...
|---------------------|--------------------|
| <img loading="lazy" src='/assets/images/smart-visual-testing/screenshot.webp' alt="Profile" width="1360" height="603" /> | <img loading="lazy" src='/assets/images/smart-visual-testing/cropped_ss.jpg' alt="Profile" width="1360" height="603" /> |

## Best Practices

<Tabs className="docs__val" groupId="best-practices">
<Tab title="Project and Build Naming">
...
<Tab title="App and Test Suite Management">
...
<Tab title="Test Execution Fails">
...
<Tab title="Screenshots Show Incorrect Content">
...
<Tab title="Sharding Not Working">
