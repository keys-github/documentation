...
"og:description": "Boost market delivery with TestMu AI's integration with Semaphore CI and automate tests on a cloud grid with 3000+ real browsers seamlessly."
---
...
```js
version: v1.0
name: Run Protractor Test In TestMu AI
agent:
  machine:
    type: e1-standard-2
    os_image: ubuntu1804
