...
"og:description": "Boost bug detection speed using HyperExecute smart UI testing with Cypress. Perform Visual UI Regression Testing for perfect app delivery."
---
...
<img loading="lazy" src='/assets/images/hyperexecute/integration/lt-products/smart-ui/cypress/1.png' alt="cmd" width="768" height="373" />

- Click on **Compare** button to compare the changes made.

<img loading="lazy" src='/assets/images/hyperexecute/integration/lt-products/smart-ui/cypress/2.png' alt="cmd" width="768" height="373" />
