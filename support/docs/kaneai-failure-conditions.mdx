...
keywords: ['failure conditions', 'assertion', 'hard assertion', 'kane ai instructions']
"og:description": "Failure Conditions for test steps to decide on the behavior of test execution & status on failure of individual steps"
---
...
<img loading="lazy" src='/assets/images/kane-ai/knowledge-base/failure-conditions/failure_conditions.png' alt="failure_conditions" />
...
<img loading="lazy" src='/assets/images/kane-ai/knowledge-base/failure-conditions/failure-conditions-org-settings.png' alt="failure_conditions_default_settings" />
