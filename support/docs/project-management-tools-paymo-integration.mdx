...
sidebarTitle: "Paymo"
keywords: ['testmu ai integrations', 'push issues to paymo', 'free cross browser testing tool']
"og:description": "TestMu AI helps you manage your bugs in Paymo by moving them to project in a single click with details like task list, assignee, title and description in Paymo project."
---
...
<img loading="lazy" src='/assets/images/project-management-tools-paymo-integration/paymo-integration.webp' alt="pymo integration" width="1344" height="642" />
...
<img loading="lazy" src='/assets/images/project-management-tools-paymo-integration/paymo-api-token.webp' alt="api token" width="1365" height="644" />
...
<img loading="lazy" src='/assets/images/project-management-tools-paymo-integration/paymo-instance.webp' alt="instance" width="1361" height="655" />

**Step 6:** As you click on settings icon, go to **"Your Settings".**

<img loading="lazy" src='/assets/images/project-management-tools-paymo-integration/paymo-settings.webp' alt="settings" width="1365" height="650" />
...
<img loading="lazy" src='/assets/images/project-management-tools-paymo-integration/paymo-generatepassword.webp' alt="generate password" width="1365" height="656" />
...
<img loading="lazy" src='/assets/images/project-management-tools-paymo-integration/paymo-apppassword.webp' alt="app password" width="1365" height="651" />
...
<img loading="lazy" src='/assets/images/project-management-tools-paymo-integration/paymo-apitoken.webp' alt="api token" width="1363" height="651" />
...
<img loading="lazy" src='/assets/images/project-management-tools-paymo-integration/paymo-buglogging.webp' alt="bug logging" width="1365" height="650" />
...
<img loading="lazy" src='/assets/images/project-management-tools-paymo-integration/paymo-installed.webp' alt="installed" width="1365" height="646" />
...
<img loading="lazy" src='/assets/images/project-management-tools-paymo-integration/paymo-realtimetest.webp' alt="real time test" width="1365" height="660" />
...
<img loading="lazy" src='/assets/images/project-management-tools-paymo-integration/paymo-findbugs.webp' alt="find bug" width="1348" height="619" />

**Step 4:** After a screenshot is captured, you can annotate any issue or a task with an **in-built image editor.** Once you are done highlighting the bug, click on the button that says **"Mark as Bug".**

<img loading="lazy" src='/assets/images/project-management-tools-paymo-integration/paymo-markbug.webp' alt="mark bug" width="1320" height="618" />
...
<img loading="lazy" src='/assets/images/project-management-tools-paymo-integration/paymo-createissue.webp' alt="create issue" width="1360" height="647" />
...
<img loading="lazy" src='/assets/images/project-management-tools-paymo-integration/paymo-bugmarked.webp' alt="bug marked" width="347" height="75" />

**Step 7:** Visit your Paymo dashboard. You will be able to notice the logged issue right away by going to the particular project and task list you assigned it to! All the data you provided through <BrandName /> would already be presented in it. <BrandName /> automatically includes test environment details and related screenshots in the ticket as attachments.

<img loading="lazy" src='/assets/images/project-management-tools-paymo-integration/paymo-dashboard.webp' alt="dashboard" width="1365" height="653" />
...
<img loading="lazy" src='/assets/images/project-management-tools-paymo-integration/paymo-remove.webp' alt="pymo remove" width="1358" height="642" />
