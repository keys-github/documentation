...
"og:description": "Integrating TestMu AI SCIM with JumpCloud"
---
...
- **Step 1:** Sign in to your <BrandName /> account. Don't have an account, [register for free](https://accounts.lambdatest.com/register).
  <img loading="lazy" src='/assets/images/lambdatest-scim/jumpcloud-scim/1.png' alt="jira-self-hosted-integration" /> 

- **Step 2:** Head to **Settings** > **Organization Settings** from the dropdown.
  <img loading="lazy" src='/assets/images/lambdatest-scim/jumpcloud-scim/2.png' alt="jira-self-hosted-integration" /> 
...
- **Step 3:** Go to <BrandName /> [Authentication & SSO settings](https://accounts.lambdatest.com/auth/sso) and click on Setup SSO. Head to the **Authentication and SSO** tab and click and copy the **SCIM Base URL and Bearer Token** option.
  <img loading="lazy" src='/assets/images/lambdatest-scim/jumpcloud-scim/3.png' alt="jira-self-hosted-integration" /> 
...
- **Step 4:** Log in to JumpCloud. Go to [JumpCloud Admin Console](https://console.jumpcloud.com/login/admin). Log in with your admin credentials. Sign in to the Jump-cloud. Select SSO Applications, then select Get Started.
  <img loading="lazy" src='/assets/images/lambdatest-scim/jumpcloud-scim/4.png' alt="jira-self-hosted-integration" /> 

- **Step 5:** Search for SCIM and then click on "**Create Custom Integration**" and then click next.
  <img loading="lazy" src='/assets/images/lambdatest-scim/jumpcloud-scim/5.png' alt="jira-self-hosted-integration" /> 
  <img loading="lazy" src='/assets/images/lambdatest-scim/jumpcloud-scim/6.png' alt="jira-self-hosted-integration" /> 

- **Step 6:** Check the box for "**Manage Single Sign-On (SSO)"** and then click "**Start**."
  <img loading="lazy" src='/assets/images/lambdatest-scim/jumpcloud-scim/7.png' alt="jira-self-hosted-integration" /> 

- **Step 7:** Enter the name for **Display Label**, then click the **Save Application** and click  **configure Application**.
  <img loading="lazy" src='/assets/images/lambdatest-scim/jumpcloud-scim/8.png' alt="jira-self-hosted-integration" /> 
  <img loading="lazy" src='/assets/images/lambdatest-scim/jumpcloud-scim/9.png' alt="jira-self-hosted-integration" /> 

- **Step 8:** Go to <BrandName /> [**Authentication & SSO**](https://accounts.lambdatest.com/auth/sso) settings and click on **Setup SSO**.
  <img loading="lazy" src='/assets/images/lambdatest-scim/jumpcloud-scim/10.png' alt="jira-self-hosted-integration" /> 

- Enter the **Connection Name** and Click on Add New Connection. and Select your **Identity Provider**.
  <img loading="lazy" src='/assets/images/lambdatest-scim/jumpcloud-scim/11.png' alt="jira-self-hosted-integration" /> 
  <img loading="lazy" src='/assets/images/lambdatest-scim/jumpcloud-scim/12.png' alt="jira-self-hosted-integration" />
...
- **Step 9:** Copy the required SSO details from <BrandName />, including:
  ...
  - Subject Name
  - Login URL
  <img loading="lazy" src='/assets/images/lambdatest-scim/jumpcloud-scim/13.png' alt="jira-self-hosted-integration" /> 
...
- Copy the **Metadata URL** from JumpCloud.
  <img loading="lazy" src='/assets/images/lambdatest-scim/jumpcloud-scim/14.png' alt="jira-self-hosted-integration" /> 
  <img loading="lazy" src='/assets/images/lambdatest-scim/jumpcloud-scim/15.png' alt="jira-self-hosted-integration" /> 
  <img loading="lazy" src='/assets/images/lambdatest-scim/jumpcloud-scim/16.png' alt="jira-self-hosted-integration" /> 
...
- **Step 12:** Go to <BrandName /> Dashboard and go **SSO connection**. Copy **Bearer Token** and **SCIM Base URL**.
  <img loading="lazy" src='/assets/images/lambdatest-scim/jumpcloud-scim/17.png' alt="jira-self-hosted-integration" /> 

- **Step 13:**  Go **Identity Management** and paste **SCIM Base URL** and **Bearer Token**. and then click Save button.
  <img loading="lazy" src='/assets/images/lambdatest-scim/jumpcloud-scim/18.png' alt="jira-self-hosted-integration" /> 
...
- **Step 14:** Enter email that does not exist on <BrandName /> platform and provide test email details, and click **Test Connection** and activate button.
  <img loading="lazy" src='/assets/images/lambdatest-scim/jumpcloud-scim/19.png' alt="jira-self-hosted-integration" /> 
  <img loading="lazy" src='/assets/images/lambdatest-scim/jumpcloud-scim/20.png' alt="jira-self-hosted-integration" />
