...
"og:description": "In this documentation, learn how integrate your Playwright automated tests with TestMu AI's SmartUI."
---
...
You can clone the sample repository to run `TestMu AI` automation tests with `SmartUI` and use the `plawrightCloud.js` file present in the `sdk` folder.
...
(async () => {
  ...
  await smartuiSnapshot.smartuiSnapshot(page, "TestMu AI");
