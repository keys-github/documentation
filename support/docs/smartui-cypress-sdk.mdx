...
"og:description": "In this documentation, learn how integrate your Cypress automated tests with TestMu AI's SmartUI."
---
...
1. Install required NPM modules for `<BrandName /> SmartUI Cypress SDK` in your **Frontend** project.
