...
keywords: ['testmu ai integrations', 'testmu ai integrations with test management tools', 'test management tools', 'clickup', 'clickup integrations']
"og:description": "Mark UI bugs to your ClickUp project directly while performing cross browser testing with TestMu AI. Capture screenshot, annotate and assign it to a colleague."
---
...
<img loading="lazy" src='/assets/images/clickup-integration/1-2.webp' alt="clickup integration" width="1365" height="632" />
...
<img loading="lazy" src='/assets/images/clickup-integration/3-2.webp' alt="clickup integration login" width="1365" height="632" />
...
<img loading="lazy" src='/assets/images/clickup-integration/2-2.webp' alt="clickup integration connect" width="1365" height="648" />
...
<img loading="lazy" src='/assets/images/clickup-integration/4-3.webp' alt="clickup integration successfully" width="1349" height="647" />
...
<img loading="lazy" src='/assets/images/clickup-integration/7.webp' alt="real time testing" width="1364" height="643" />
...
<img loading="lazy" src='/assets/images/clickup-integration/clickup-5.webp' alt="mark as bug icon" width="1325" height="653" />

**Step 4:** After a screenshot is captured, you can annotate any issue or a task with an in-built image editor. Once you are done highlighting the bug, click on the button that says **"Mark as Bug"**.

<img loading="lazy" src='/assets/images/clickup-integration/clickup-6.webp' alt="mark as bug" width="1365" height="650" />
...
<img loading="lazy" src='/assets/images/clickup-integration/clickup-7.webp' alt="clickup integration" width="1364" height="654" />
...
<img loading="lazy" src='/assets/images/clickup-integration/Capture15.webp' alt="clickup integration" width="347" height="75" />
...
<img loading="lazy" src='/assets/images/clickup-integration/clickup-8.webp' alt="clickup integration api" width="1365" height="651" />
...
<img loading="lazy" src='/assets/images/clickup-integration/clickup-9.webp' alt="clickup integration demo" width="1365" height="646" />
...
<img loading="lazy" src='/assets/images/clickup-integration/clickup-10.webp' alt="clickup integration remove" width="1348" height="644" />
