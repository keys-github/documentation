...
"og:description": "Your guide to running tests using Gauge on TestMu AI's Selenium Grid of 3000+ real devices and desktop browsers."
---
...
All the code samples in this documentation can be found on **<BrandName />'s Github Repository**. You can either download or clone the repository to quickly run your tests. <GitHubButton url="https://github.com/LambdaTest/gauge-selenium-sample" />
...
<p align="center">
<img loading="lazy" src='/assets/images/selenium/gauge1.png' alt="cmd" width="768" height="373" />
</p>
