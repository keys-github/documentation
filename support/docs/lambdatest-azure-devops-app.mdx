...
1. Head over to the [<BrandName />Test Manager](https://marketplace.visualstudio.com/items?itemName=<BrandName />.testmu ai-ai-tms-app) Azure DevOps App on the Azure DevOps Marketplace. Select **Get it free** as shown in the below image.
