...
**Step 1 :** Configure the tunnel using the [LT tunnel binary](/support/docs/testing-locally-hosted-pages/#testmu ai-tunnel-guide) with `--env ht-prod` mode enabled. You can use the following command to trigger your tunnel:
