...
keywords: ['analytics', 'smart tags']
"og:description": "Analyze tests faster with Smart Tags in TestMu AI Analytics. Get insights on your test automation execution with Smart Tags."
---
...
For more information on Flaky Tests, you can refer to our [Flaky Tests Guide](/support/docs/test-intelligence-flakiness-test-detection/).
