---
title: "ADB Shell"
sidebarTitle: "ADB Shell"
keywords: ['real device app testing', 'adb shell', 'adb command']
"og:description": "ADB shell support in TestMu AI for direct command execution on Android devices during manual testing."
---
...
<img loading="lazy" src='/assets/images/real-device-app-testing/adbmanual.webp' alt="ADB Shell Access" width="1366" height="629" />
