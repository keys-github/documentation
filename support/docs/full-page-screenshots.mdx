...
"og:description": "LT Browser allows you to capture full-page screenshots of your pre-installed mobile devices, desktops and laptops and compare them across multiple viewports."
---
