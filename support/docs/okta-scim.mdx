...
"og:description": "Integrating TestMu AI SCIM with Okta"
---
...
<img loading="lazy" src='/assets/images/lambdatest-scim/okta/applications-tab.png' alt="Image" width="404" height="206"  className="doc_img img_center" /><br />

**Step 5:** In the applications list, select application used for <BrandName /> SSO setup

**Step 6:** Select the Provisioning tab.
<img loading="lazy" src='/assets/images/lambdatest-scim/okta/provisioning-tab.png' alt="Image" width="404" height="206"  className="doc_img img_center" /><br />
...
<img loading="lazy" src='/assets/images/lambdatest-scim/okta/integration-tab.png' alt="Image" width="404" height="206"  className="doc_img img_center" /><br />

**Step 8:** Now navigate to App tab
<img loading="lazy" src='/assets/images/lambdatest-scim/okta/app-tab.png' alt="Image" width="404" height="206"  className="doc_img img_center" /><br />

**Step 9:** Review the User Attribute mappings:
<img loading="lazy" src='/assets/images/lambdatest-scim/okta/mapping-tab.png' alt="Image" width="404" height="206"  className="doc_img img_center" /><br />
...
<img loading="lazy" src='/assets/images/lambdatest-scim/okta/provisioning-enabled.png' alt="Image" width="404" height="206"  className="doc_img img_center" /><br />
