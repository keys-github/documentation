...
sidebarTitle: "Advanced TestMu AI Tunnel Features"
...
"og:description": "This provides you with all the Advanced features of the TestMu AI Tunnel."
---
...
You can download the **<BrandName /> Tunnel binary** that will help you establish a secure connection through corporate firewalls between your computer and [<BrandName />](https://www.lambdatest.com/) cloud servers for a testing locally hosted website or web-applications. You can test plain **HTML, CSS, PHP, Python** or other similar web files saved on your local system, over combinations of operating systems, browsers, and screen resolutions that are available on <BrandName />.
...
```bash title="Format"
LT --user {Your Registered Email ID} --key {Your TestMu AI Access Key} --tunnelName {any random string}
```
...
<img loading="lazy" src='/assets/images/lambda-tunnel-for-corporate-firewalls/Executing-Lambda-Tunnel.webp' alt="Advanced <BrandName /> Tunnel" width="1179" height="472" />
...
<img loading="lazy" src='/assets/images/lambda-tunnel-for-corporate-firewalls/test-using-lambda-tunnel.webp' alt="Advanced <BrandName /> Tunnel" width="970" height="313" />
...
<img loading="lazy" src='/assets/images/lambda-tunnel-for-corporate-firewalls/lt-yaml-file.webp' alt="Advanced <BrandName /> Tunnel" width="978" height="239" />
...
<img loading="lazy" src='/assets/images/lambda-tunnel-for-corporate-firewalls/automatic-verbose-logs.webp' alt="Advanced <BrandName /> Tunnel" width="1359" height="639" />
...
<img loading="lazy" src='/assets/images/lambda-tunnel-for-corporate-firewalls/Local-Testing-By-MITM.webp' alt="Advanced <BrandName /> Tunnel" width="1266" height="657" />

You can test such websites by leveraging the **MITM** mode. The command will look like this:

`LT --user salmank@lambdatest.com --key 123456789abcdefghijklmnopqrstuv --tunnelName TestMu AI --mitm`
...
<img loading="lazy" src='/assets/images/lambda-tunnel-for-corporate-firewalls/test-using-mitm-mode.webp' alt="Advanced <BrandName /> Tunnel" width="1069" height="687" />
...
```bash
LT --user salmank@lambdatest.com --key 123456789abcdefghijklmnopqrstuv --tunnelName TestMu AI --infoAPIPort 8000
```

<img loading="lazy" src='/assets/images/lambda-tunnel-for-corporate-firewalls/Using-Tunnel-InfoAPIs.webp' alt="Advanced <BrandName /> Tunnel" width="1356" height="683" />
...
<img loading="lazy" src='/assets/images/lambda-tunnel-for-corporate-firewalls/fetch-tunnel-status.webp' alt="Advanced <BrandName /> Tunnel" width="1365" height="231" />
...
<img loading="lazy" src='/assets/images/lambda-tunnel-for-corporate-firewalls/stop-current-tunnel.webp' alt="Advanced <BrandName /> Tunnel" width="1365" height="223" />
...
<img loading="lazy" src='/assets/images/lambda-tunnel-for-corporate-firewalls/tunnel-argument.webp' alt="Advanced <BrandName /> Tunnel" width="1219" height="715" />

> **Note:** For all modifiers/arguments, refer to the list of [<BrandName /> Tunnel Modifiers](/support/docs/lambda-tunnel-modifiers/).

That was all you need to know for configuring a client connection through <BrandName /> Tunnel. In case you have any questions, feel free to share them with us through our <span className="doc\_\_lt" onClick={() => window.openLTChatWidget()}>**24/7 chat support**</span> or drop us an email to [support@testmuai.com](mailto:support@testmuai.com). Happy testing! 🙂
