---
title: Getting started with TestMuAI's SmartUI Figma CLI
...
"og:description": "In this documentation, learn how to perform Visual Testing of your Figma files using command line interface using SmartUI CLI."
---
