...
"og:description": "In this documentation, learn how integrate your Selenium JavaScript automated tests with TestMu AI's SmartUI."
---
...
You can clone the sample repository to run `<BrandName />` automation tests with `SmartUI` and use the `sdk.js` file present in the `sdk` folder.
...
(async function example() {
  ...
  try {
    ...
    await smartuiSnapshot(driver, "<BrandName />");
