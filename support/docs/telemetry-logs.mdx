...
"og:description": "In this documentation, learn how to debugging your Selenium tests using Telemetry logs."
---
...
<iframe 
  width="560" 
  height="315" 
  src="https://www.youtube.com/embed/uOGxauw0K4w" 
...
<img loading="lazy" src='/assets/images/telemetry-logs/download.png' alt="cmd" />
...
<img loading="lazy" src='/assets/images/telemetry-logs/upload.png' alt="cmd" />
