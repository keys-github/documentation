...
sidebarTitle: "Notion"
keywords: ['TestMu AI integration with Notion', 'TestMu AI and Notion Integration', 'Notion Integration']
"og:description": "Perform one-click bug logging while performing cross browser testing with TestMu AI and Notion integration. Capture screenshots, annotate issues, and share them directly from the TestMu AI platform to your Notion pages."
---
...
<img loading="lazy" src='/assets/images/notion-integration/resync-notion.png' alt="Image" width="1353" height="622" />
...
<img loading="lazy" src='/assets/images/notion-integration/select-notion.webp' alt="Image" width="1353" height="622" />

<Warning>
: Make sure you have created an account on Notion.
</Warning>


3. You will be taken to OAuth Page. Click on **Select Pages**. 

<img loading="lazy" src='/assets/images/notion-integration/select-pages.webp' alt="Image" width="1353" height="622" />

4. Choose the page on which you want to give an access. For example, in the below screenshot, we select *DemoTest1* page.

<img loading="lazy" src='/assets/images/notion-integration/choose-pages.webp' alt="Image" width="1353" height="622" />

5. After selecting the pages, click on **Allow Access**.

<img loading="lazy" src='/assets/images/notion-integration/allow-access.webp' alt="Image" width="1353" height="622" />
...
<img loading="lazy" src='/assets/images/notion-integration/addpage.webp' alt="Image" width="1353" height="622" />

2. Select **Board**.

<img loading="lazy" src='/assets/images/notion-integration/board.webp' alt="Image" width="1353" height="622" />

3. Give a relevant title and add your desired properties in the board.

<img loading="lazy" src='/assets/images/notion-integration/kanban.webp' alt="Image" width="1353" height="622" />
...
<img loading="lazy" src='/assets/images/notion-integration/select-config.webp' alt="Image" width="1353" height="622" />
...
<img loading="lazy" src='/assets/images/notion-integration/spider-icon.webp' alt="Image" width="1353" height="622" />
...
<img loading="lazy" src='/assets/images/notion-integration/mark-as-bug.webp' alt="Image" width="1353" height="622" />
...
<img loading="lazy" src='/assets/images/notion-integration/create-issue.webp' alt="Image" width="1353" height="622" />
...
<img loading="lazy" src='/assets/images/notion-integration/visit-issuetracker.webp' alt="Image" width="1353" height="622" />

7. To view your marked bugs in Notion, click on the right diagonal arrow icon. 

<img loading="lazy" src='/assets/images/notion-integration/rd-arrowicon.webp' alt="Image" width="1353" height="622" />

You'll be routed to the Notion dashboard where you can find your marked issues along with the test environment details.

<img loading="lazy" src='/assets/images/notion-integration/marked-issue.webp' alt="Image" width="1353" height="622" />
...
<img loading="lazy" src='/assets/images/notion-integration/remove-notion.webp' alt="Image" width="1353" height="622" />

The Notion integration will be uninstalled.

In case you have any doubts or questions, feel free to drop them at our <span className="doc__lt" onClick={() => window.openLTChatWidget()}>**24x7 Chat Support**</span> or you could also mail us directly at **[support@testmuai.com](mailto:support@testmuai.com)**.
