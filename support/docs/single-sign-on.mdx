...
keywords: [testmu single sign on, testmu single sign-on, testmu SSO]
"og:description": "Single sign-on (SSO) is an authentication feature that allows users to authenticate and access to TestMu AI through an identity provider (IdP)."
---
...
<img loading="lazy" src='/assets/images/lambdatest-mfa/new-dashboard.webp' alt="Image" width="404" height="206"  className="doc_img img_center" /><br />

**Step 2:**  Click on the **User Icon** on the top right and select **Organization Settings** from the dropdown.

<img loading="lazy" src='/assets/images/lambdatest-mfa/org-settings-new.webp' alt="Image" width="404" height="206"  className="doc_img img_center" /><br />

**Step 3:**  Head to the **Security** tab and click the **SSO** option.

<img loading="lazy" src='/assets/images/lambdatest-mfa/sso-setup.webp' alt="Image" width="404" height="206"  className="doc_img img_center" /><br />
