...
sidebarTitle: "Python Use Cases"
keywords: ['TestMu AI Hyperexecute', 'TestMu AI Hyperexecute help', 'TestMu AI Hyperexecute documentation', 'TestMu AI Projects', 'Python', 'Behave', 'Robot']
...
- **Installation :**
```bash
npm install -g testmu ai-screenshot-pdf
```

- **Usage :**
```bash
AUTH_HEADER="Basic your_encoded_auth_string" testmu ai-screenshot-pdf <session_id> --output <output_directory>
```

- **Example :**
```bash
AUTH_HEADER="Basic cmF0aG9yZXYXYXYXYXXgybFlXTm5LclZPeVRRQ01RRGdyNTZjVg==" \
testmu ai-screenshot-pdf 1a80510a-289a-46b7-9f60-da01d108de10 --output ~/Desktop/screenshots
```
