...
<img loading="lazy" src='/assets/images/hyperexecute/integration/products/accelq/accelq-1.webp' alt="accelq-dashboard"  width="1920" height="868" />

#### How to create a Job ID?

**Step 1:** Create an LT profile with with the below configuration and save it
<img loading="lazy" src='/assets/images/hyperexecute/integration/products/accelq/accelq-2.webp' alt="accelq-dashboard"  width="1920" height="868" />
...
<img loading="lazy" src='/assets/images/hyperexecute/integration/products/accelq/accelq-3.webp' alt="accelq-dashboard"  width="1920" height="868" />

**Step 3:** Copy the Job ID
<img loading="lazy" src='/assets/images/hyperexecute/integration/products/accelq/accelq-4.webp' alt="accelq-dashboard"  width="1920" height="868" />
...
- You can configure your [<BrandName /> from Accelq Agent Dashboard](/support/docs/accelq-integration/#integrating-testmu ai-from-accelq-agent-dashboard)
...
web_provider_username = <TestMu AI Username>
web_provider_password = <TestMu AI AccessKey>
...
provider_password = <TestMu AI AccessKey>
provider_username = <TestMu AI Username>
```
