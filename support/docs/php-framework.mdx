...
"og:description": "Complete guide to running your first PHP Selenium automation test scripts on TestMu AI Selenium Grid cloud. Test on 3000+ different desktop and mobile browsers."
---
...
>**Note:** All the code samples in this documentation can be found in the [Behat <BrandName /> Repository on  GitHub](https://github.com/<BrandName />-sample-test-frameworks/Php-Selenium). You can either download or clone the repository to quickly run your tests.
...
**Step 1:** Clone the <BrandName />’s [Php-Selenium repository](https://github.com/<BrandName />-sample-test-frameworks/Php-Selenium) and navigate to the code directory as shown below:
```bash
