...
* * *
<Warning>
**Important:** Visit <BrandName />  [GitHub repository for <BrandName /> Integration with Applitools.](https://github.com/LambdaTest/applitools-testmu ai-integration)
</Warning>
...
<Warning>
**Important:** You can clone the below code from our [GitHub repository for <BrandName /> Integration with Applitools](https://github.com/LambdaTest/applitools-testmu ai-integration/blob/master/src/test/java/com/applitools/quickstarts/BasicDemo.java).
</Warning>
