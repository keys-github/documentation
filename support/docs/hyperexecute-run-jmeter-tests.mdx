...
"og:description": "Perform the steps to learn how to do the performance testing on HyperExecute using the jmeter tests plans"
---
...
<img loading="lazy" src='/assets/images/hyperexecute/frameworks/performance_testing/summary-report.png' alt="HyperExecute"  width="1920" height="868" />

### Timeline Report

<img loading="lazy" src='/assets/images/hyperexecute/frameworks/performance_testing/timeline-report.png' alt="HyperExecute"  width="1920" height="868" />

### Request Stats

You can analyze the number of requests sent on that particular time.

<img loading="lazy" src='/assets/images/hyperexecute/frameworks/performance_testing/request-stats.png' alt="HyperExecute"  width="1920" height="868" />

### Errors
- Here you can check the Error Code type, Error Count, percentage of that error, and the percent of error in all the samples.

<img loading="lazy" src='/assets/images/hyperexecute/frameworks/performance_testing/error-reports.png' alt="HyperExecute"  width="1920" height="868" />

### Logs
- You can check the logs of your Jobs executed.

<img loading="lazy" src='/assets/images/hyperexecute/frameworks/performance_testing/logs.png' alt="HyperExecute"  width="1920" height="868" />
