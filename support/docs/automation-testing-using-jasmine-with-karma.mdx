...
sidebarTitle: "Jasmine for BDD"
keywords: ['jasmine selenium', 'karma selenium', 'javascript selenium', 'javascript automation testing', 'selenium webdriver javascript', 'selenium javascript testing tutorial', 'javascript selenium framework']
"og:description": "Now you can run your automation scripts using Jasmine with Karma on TestMu AI online grid of 3000+ real desktop browsers and real operating systems."
---
...
* * *
>All the code samples in this documentation can be found in the [Jasmine <BrandName /> Repository on <img src='/assets/images/GitHub_icon/github-icon.webp' alt="Image" width="25" height="25"  /> GitHub](https://github.com/LambdaTest/karma-jasmine-sample). You can either download or clone the repository to quickly run your tests.
...
describe('updateAppState', function () {
    it('should push a new state into the browser history', function () {
        window.updateAppState({
            message: 'Getting Started with TestMu AI'
        });
...
<Warning>
: psuedoActivityInternal is presented as a default parameter with a value set to 0. Make sure to provide a value more than 0 in order to avoid the timeouts.
</Warning>
