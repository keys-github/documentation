...
keywords: ['testmu ai', 'web scanner', 'accessibility scan', 'wcag', 'ada compliance']
"og:description": "Learn how to configure an Accessibility scan, including WCAG version, handling of review issues, and advanced settings like local testing and authentication."
---
...
<img loading="lazy" src='/assets/images/web-scanner/accessibility-scan-purpose.png' alt="Accessibility Scan Purpose" />
...
<img loading="lazy" src='/assets/images/web-scanner/accessibility-scan-config-ui.png' alt="Accessibility Scan Configuration UI" />
...
<img loading="lazy" src='/assets/images/web-scanner/accessibility-scan-advanced-options.png' alt="Accessibility Scan Advanced Options" />
...
<img loading="lazy" src='/assets/images/web-scanner/accessibility-build.png' alt="Visual Build" />
