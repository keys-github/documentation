...
keywords: ['testmu ai integrations', 'continuous integration', 'buildkite', 'buildkite integration', 'testmu ai buildkite integration']
"og:description": "TestMu AI offers continuous integration with Buildkite to ease your automated cross browser testing process through their Selenium grid consisting more than 3000+ browsers."
---
...
<img loading="lazy" src='/assets/images/buildkite-integration/create-pipeline.png' alt="Create pipeline in Buildkite" width="1365" height="650" />
...
<img loading="lazy" src='/assets/images/buildkite-integration/connect-repository.png' alt="Connect repository. Add name and description." width="1365" height="650" />
...
<img loading="lazy" src='/assets/images/buildkite-integration/username-accesskey.png' alt="Add username and accesskey" width="1365" height="650" />
...
In the example repository, there is only a single step - executing the `testmu ai.py` file. That can be done with the following code:

```
python3 testmu ai.py
```

You can add additional steps by clicking on the `Add` button. Once all the steps are added, you can click `Create Pipeline`.

<img loading="lazy" src='/assets/images/buildkite-integration/add-steps.png' alt="Add steps" width="1365" height="650" />
...
<img loading="lazy" src='/assets/images/buildkite-integration/agent.png' alt="Add agent" width="1365" height="650" />
...
<img loading="lazy" src='/assets/images/buildkite-integration/create-build.png' alt="Create and run a build" width="1365" height="650" />

<img loading="lazy" src='/assets/images/buildkite-integration/dashboard.png' alt="Build details on Automation Dashboard" width="1365" height="650" />
...
<img loading="lazy" src='/assets/images/buildkite-integration/yaml/1.png' alt="settings page" width="1365" height="650" />
...
<img loading="lazy" src='/assets/images/buildkite-integration/yaml/2.png' alt="settings page" width="1365" height="650" />
...
<img loading="lazy" src='/assets/images/buildkite-integration/yaml/3.png' alt="settings page" width="1365" height="650" />
