...
<a href="https://github.com/LambdaTest/cucumber-selenium-hyperexecute-sample.git" className="github__anchor"><img loading="lazy" src='/assets/images/icons/github.png' alt="Image" /> View on GitHub</a>
