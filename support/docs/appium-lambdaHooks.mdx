...
keywords: ['appium', 'testmu ai hooks', 'custom status', 'custom remark', 'app automation', 'mobile test', 'app testing', 'real devices']
"og:description": "Now you can add custom status & remark to your App Automation scripts that you run on TestMu AI."
---
...
<img loading="lazy" src='/assets/images/appium-lambdaHooks/01.webp' alt="Build Page Remark" width="1200" height="550" />
