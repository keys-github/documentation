...
keywords: ['nemo selenium', 'nemojs selenium', 'nemojs automation testing', 'nemojs automation framework']
"og:description": "This document will help you run Selenium automated tests with NemoJS across 3000+ browsers and operating systems on TestMu AI cloud Selenium Grid."
---
...
## Prerequisites
* * *
All the code samples in this documentation can be found in the [NemoJS <BrandName /> Repository on <img src='/assets/images/GitHub_icon/github-icon.webp' alt="Image" width="25" height="25"  /> GitHub](https://github.com/LambdaTest/Nemo-<BrandName />-sample). You can either download or clone the repository to quickly run your tests.
