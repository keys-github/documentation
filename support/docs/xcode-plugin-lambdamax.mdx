...
"og:description": "TestMu AI XCode plugin to run automated tests directly on the TestMu AI grid."
---
...
<img loading="lazy" src='/assets/images/lambdamax/lambdamax-main.webp' alt="Image" width="1444" height="703"  className="doc_img img_center" /><br />

2. Head to **Product** on the menu bar in the top-left corner.

<img loading="lazy" src='/assets/images/lambdamax/lambdamax-menu.webp' alt="Image" width="1444" height="703"  className="doc_img img_center" />

3. Hover on the **Scheme** option from the dropdown and click on the **Edit Scheme** from the dropdown list. 

<img loading="lazy" src='/assets/images/lambdamax/lambdamax-dropdown.webp' alt="Image" width="1444" height="703"  className="doc_img img_center" />

4. In the pop-up window, click and expland the **Build** option from the sidebar. 

<img loading="lazy" src='/assets/images/lambdamax/lambdamax-build-option.webp' alt="Image" width="1444" height="703"  className="doc_img img_center" />

5. Head to the **Post Actions** option from the sidebar and copy the sample code. 

<img loading="lazy" src='/assets/images/lambdamax/lambdamax-build-dropdown.webp' alt="Image" width="1444" height="703"  className="doc_img img_center" />
...
<img loading="lazy" src='/assets/images/lambdamax/lambdamax-build-code.webp' alt="Image" width="1444" height="703"  className="doc_img img_center" />
...
<img loading="lazy" src='/assets/images/lambdamax/lambdamax-play.webp' alt="Image" width="1444" height="703"  className="doc_img img_center" /><br />
...
<img loading="lazy" src='/assets/images/lambdamax/lambdamax-profile.webp' alt="Image" width="1444" height="703"  className="doc_img img_center" /><br />
